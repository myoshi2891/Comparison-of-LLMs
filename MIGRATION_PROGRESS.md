...
| D | Long-form guides × 9（全ページ HTML → JSX 直接移植。MDX 不採用） | **着手中** — D-1 Green s01 完了 | Red: `af1e9e7` / s01: `e16174a` |
...
- 最新 HEAD: e16174a（feat(web-next): D-1 Green s01 (SKILL.md とは何か？) 移植完了）
...
次の作業: **D-1 Green s02 着手** — s01 完了（e16174a）。
...
D-1 `/claude/skill-guide` は s01 完了。次は Green s02（`arch` セクション行 828–917）を実装する。
- `MermaidDiagram` は `components/docs/MermaidDiagram.tsx` に実装済み（mermaid@10.9.5、next/dynamic ssr:false で使用）
- セクション構造: hero(745-758) / what(760-827) / arch(828-917) / token(920-998) / structure(999-1058) / directory(1059-1141) / invoke(1142-1212) / claudemd(1213-1285) / build(1286-1423) / yaml(1424-1530) / args(1531-1583) / bundle(1584-1615) / best(1616-1690) / debug(1691-1750) / mistakes(1751-1827) / enterprise(1828-2008)
