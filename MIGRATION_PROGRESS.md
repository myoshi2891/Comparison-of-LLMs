...
| D | Long-form guides × 9（全ページ HTML → JSX 直接移植。MDX 不採用） | **D-1・D-2・D-3 完了、D-4 未着手**（D-1: 全 15 セクション完了・D-2: 全 9 セクション完了・D-3: 全 11 セクション完了）| Red: `af1e9e7` / D-1 全: `be2aef0` / D-2 Red: `d491da8` / D-2 全: `a62ceec` / D-3 Red: `11d9e79` / D-3 s01: `4f29f56` / s02: `10dca55` / s03: `7a2d136` / s04: `8bbfacb` / s05: `f496ac2` / s06: `998cb6d` / s07: `9a1f485` / s08: `6b8fb8c` / s09: `405c899` / s10: `8a919aa` / s11: `b32b162` |
...
D-4 のファイル: `legacy/gemini/skill-guide-for-gemini.html`（行数は `wc -l` で確認してから着手）
出力先: `web-next/app/gemini/skill-guide/page.tsx`（新規作成）
- docs/NEXTJS_PHASE_A_F_PLAN.md §Phase D でセクション数・行範囲を確認してから着手
- lint 既知違反: 7 件
