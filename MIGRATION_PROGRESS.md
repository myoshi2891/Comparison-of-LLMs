...
次の作業: **C-4 s03 実装（即着手可能）** — s02（1a7e7e9）完了済み。次は lines 798-876 `.github/instructions/*.instructions.md`（card + 2 code + alert）
