...
- **ブランチ**: `feat/nextjs-migration`
- 最新 HEAD: 8fffdb9（feat(web-next): scaffold /git-worktree Phase E Red）
- 未コミット作業: なし（working tree クリーン）
- 次の作業: **Phase E s00 — `git_worktree.html` 723-1287 行 faithful 移植**（scaffold 完了）
...
- ビルド: `bun run build` ✅（8fffdb9 時点）・`bun run typecheck` ✅・`uv run pytest` 5/5 passed
- **lint 既知違反**: 7 件
...
| E | git_worktree.html（Mermaid + SVG） | **進行中**（scaffold 完了 `8fffdb9`、s00 移植着手前） | scaffold: `8fffdb9` |
