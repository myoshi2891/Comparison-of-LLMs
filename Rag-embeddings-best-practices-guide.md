...
「動いているように見える」ことと「実際に正しい」ことは別物です。実務で推奨される傾向として、多くの企業において新規RAGデプロイ時にサービス開始の初日から体系的な自動評価（RAGASやTruLensによる品質ゲート）をパイプラインに組み込んで運用することが重視されています。これは、業界全体がRAGを「作って終わり」ではなく「継続的に測定するもの」として扱うことの重要性を認識し始めていることを示しています。
