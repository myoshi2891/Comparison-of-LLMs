...
flowchart TD
    ...
    subgraph PHASE2["Phase 2: 繰り返し実行（Coding Agent）"]
        ...
        S5 --> S6[6. E2E テスト]
        S6 -->|失敗| S5
        S6 -->|成功| S7[7. feature_list.json を passes: true に更新]
...
| **テストなし完了マーク** | コード変更したが動作未確認のまま passes: true にする | feature_list.json に検証ステップを明記 | E2E テストで実際の UI を確認後のみ passes: true に変更 |
