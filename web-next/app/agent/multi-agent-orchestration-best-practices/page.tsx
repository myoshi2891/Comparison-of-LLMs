            ...
            <ul>
              <li>
                <a href="#sec-1" className={styles.tocLink}>
                  <span className={styles.num}>01</span>なぜ今マルチエージェントか
                </a>
              </li>
              <li>
                <a href="#sec-2" className={styles.tocLink}>
                  <span className={styles.num}>02</span>5つのワークフローパターン
                </a>
              </li>
            </ul>
          </nav>
            ...
            <ul>
              <li>
                <a href="#sec-3" className={styles.tocLink}>
                  <span className={styles.num}>03</span>全カタログ
                </a>
              </li>
              <li>
                <a href="#sec-4" className={styles.tocLink}>
                  <span className={styles.num}>04</span>Anthropicリサーチシステム
                </a>
              </li>
              <li>
                <a href="#sec-5" className={styles.tocLink}>
                  <span className={styles.num}>05</span>コンテキスト・エンジニアリング
                </a>
              </li>
              <li>
                <a href="#sec-6" className={styles.tocLink}>
                  <span className={styles.num}>06</span>主要フレームワーク比較
                </a>
              </li>
              <li>
                <a href="#sec-7" className={styles.tocLink}>
                  <span className={styles.num}>07</span>プロトコル: MCPとA2A
                </a>
              </li>
            </ul>
          </nav>
            ...
            <ul>
              <li>
                <a href="#sec-8" className={styles.tocLink}>
                  <span className={styles.num}>08</span>失敗モード分類(MAST)
                </a>
              </li>
              <li>
                <a href="#sec-9" className={styles.tocLink}>
                  <span className={styles.num}>09</span>セキュリティとガードレール
                </a>
              </li>
              <li>
                <a href="#sec-10" className={styles.tocLink}>
                  <span className={styles.num}>10</span>可観測性と評価
                </a>
              </li>
              <li>
                <a href="#sec-11" className={styles.tocLink}>
                  <span className={styles.num}>11</span>コスト最適化とトークン管理
                </a>
              </li>
            </ul>
          </nav>
            ...
            <ul>
              <li>
                <a href="#sec-12" className={styles.tocLink}>
                  <span className={styles.num}>12</span>意思決定フレームワーク
                </a>
              </li>
              <li>
                <a href="#sec-13" className={styles.tocLink}>
                  <span className={styles.num}>13</span>ステップバイステップ実装
                </a>
              </li>
              <li>
                <a href="#sec-14" className={styles.tocLink}>
                  <span className={styles.num}>14</span>チェックリストとまとめ
                </a>
              </li>
              <li>
        ...
        <div className={styles.content}>
          <div className={styles.contentInner}>
            ...
            <section className={styles.docSection} id="sec-2">
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td>
                        <strong>Prompt Chaining(逐次連鎖)</strong>
                      </td>
                    ...
                    <tr>
                      <td>3</td>
                      <td>
                        <strong>Parallelization(並列化)</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>5</td>
                      <td>
                        <strong>Evaluator-Optimizer(評価・最適化ループ)</strong>
                      </td>
              ...
              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_2_1} />
                <div className={styles.diagramCaption}>図2-①: Prompt Chaining(逐次連鎖)</div>
              </div>

              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_2_2} />
                <div className={styles.diagramCaption}>図2-②: Routing(振り分け)</div>
              </div>

              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_2_3} />
                <div className={styles.diagramCaption}>図2-③: Parallelization(並列化)</div>
              </div>

              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_2_4} />
                <div className={styles.diagramCaption}>図2-④: Orchestrator-Workers</div>
              </div>

              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_2_5} />
                <div className={styles.diagramCaption}>
                  図2-⑤: Evaluator-Optimizer(評価・最適化ループ)
                </div>
              </div>
                ...
                <ul>
                  ...
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Building effective agents(要約と論評)— Simon Willison
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Agent Workflow Patterns — Beyond Anthropic's Playbook — Towards AI
                    </a>
                  </li>
                  <li>
                    <a
            ...
            <section className={styles.docSection} id="sec-3">
              ...
              <div className={styles.diagramWrap}>
                ...
                <div className={styles.diagramCaption}>図3: オーケストレーター・ワーカー型</div>
              </div>
              ...
              <div className={styles.diagramWrap}>
                ...
                <div className={styles.diagramCaption}>図4: スーパーバイザー型の対話フロー例</div>
              </div>

              <h3>3.3 スウォーム型(Swarm / Peer-to-Peer)</h3>
              <p>
                中央のコーディネーターを置かず、エージェント同士が直接「ハンドオフ(制御の受け渡し)」を行う分散型パターンです。LangGraphの
                <code>langgraph-swarm</code>やOpenAI Agents SDKの<code>handoffs</code>
                機能がこれに該当します。レイテンシは低い(仲介者を挟まないため)反面、経路の追跡が難しく、完全連結型のスウォームでは、エージェント数の増加に伴い障害点の組み合わせが
                <strong>組合せ的に爆発</strong>
                します(4エージェントで6通り、10エージェントで45通りの相互作用パス)。8エージェントを超えると、この失敗表面積はEnd-to-Endテストでカバーしきれなくなるとされ、階層型オーケストレーションへの切り替えが信頼性上の要件になります。
              </p>

              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_5} />
                <div className={styles.diagramCaption}>図5: スウォーム型(完全連結)</div>
              </div>

              <h3>3.4 階層型マルチレベル・スーパーバイザー(Hierarchical Multi-Level Supervisor)</h3>
              <p>
                スーパーバイザーがさらに別のスーパーバイザーを管理する「スーパーバイザーのスーパーバイザー」構造です。LangGraphでは
                <code>create_supervisor</code>
                にサブチームを渡すことで多段階の階層システムを構築できます。大規模な組織構造を模した設計に適しており、責任の連鎖(chain
                of
              ...
              <div className={styles.diagramWrap}>
                ...
                <div className={styles.diagramCaption}>図7: ディベート型</div>
              </div>
              ...
              <div className={styles.refs}>
                ...
                <ul>
                  ...
                  <li>
                    <a
                      href="https://www.augmentcode.com/guides/swarm-vs-supervisor"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      LangGraph Advanced – Hierarchical Multi-Level Supervisor & Swarm Agents
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Multi-Agent Orchestration in LangGraph: Supervisor vs Swarm — DEV Community
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://pypi.org/project/langgraph-supervisor/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <section className={styles.docSection} id="sec-4">
              ...
              <p>
                Anthropicの分析では、BrowseCompの内部評価においてトークン使用量だけで性能分散の
                <strong>80%</strong>
                を説明できるという結果が出ています(ツール呼び出し数とモデル選択が残りを説明)。つまり、マルチエージェント化の本質的な価値は「複数の独立したコンテキストウィンドウに計算資源(トークン)を分散させ、単一エージェントでは実現できない規模の推論を可能にすること」にあります。
              </p>

              <p>
                一方でこの並列化にはコストが伴います。マルチエージェントシステムは通常のチャット対話のおよそ
                <strong>15倍のトークン</strong>を消費します。Opus 4をリードエージェント、Sonnet
                4をサブエージェントとした構成では、単一エージェントのOpus
                4と比較して調査タスクの内部評価で<strong>90.2%の性能向上</strong>
                を達成した一方、この15倍のコストは「アウトプットの価値がコストを上回る、高付加価値なタスク」でのみ正当化されると明言されています。
              </p>
              ...
              <p>
                コーディング、デバッグ、そしてほとんどのエージェント的ワークフローはこの条件に当てはまり、マルチエージェント化に不向きとされています。サブエージェントBがサブエージェントAの調査結果に依存する場合、並列化は「オーバーヘッド付きの高コストな直列実行」に退化してしまうためです。並列サブエージェントが機能するのは、サブタスクが
                <strong>真に独立</strong>している場合に限られます。
              </p>
              ...
              <div className={styles.tableWrap}>
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <strong>エージェントの思考をシミュレートする</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>オーケストレーターに委任方法を教える</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>努力量をタスクの複雑さにスケーリングさせる</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>
                          拡張思考(Extended Thinking)を制御可能なスクラッチパッドとして使う
                        </strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>並列化を前提としたプロンプト設計に切り替える</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>人間による評価は自動化では拾えないものを拾う</strong>
                      </td>
                      <td>
              ...
              <ul>
                <li>
                  ツール呼び出し失敗をまたいだ<strong>エージェント状態の永続化</strong>
                </li>
                <li>
                  動的な挙動をデバッグするための<strong>完全なトレーサビリティ</strong>
                </li>
                <li>
                  中断のない<strong>レインボーデプロイ</strong>
                  (段階的ロールアウトによる安全なアップデート)
                </li>
                <li>
                  現状は<strong>同期的実行</strong>
                  がボトルネックであり、より高い並列性を実現する非同期アーキテクチャは開発中の課題として残っている
                </li>
              </ul>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      How we built our multi-agent research system — Anthropic Engineering(一次情報)
                    </a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Anthropic's Multi-Agent Research Architecture Explained — The AI Engineer
                    </a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Anthropic: Building a Multi-Agent Research System — ZenML LLMOps Database
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <section className={styles.docSection} id="sec-5">
              ...
              <p>
                マルチエージェントシステムの実装品質を分けるのは、突き詰めれば「各エージェントに何を、いつ見せるか」という
                <strong>コンテキスト・エンジニアリング</strong>
                の設計です。Anthropicのエンジニアリングブログ
              ...
              <ul>
                <li>
                  <strong>並列化</strong>: 複数のサブエージェントを異なるタスクに同時展開できる
                </li>
                <li>
              ...
              <p>
                ...
                Codeはこの方式で、<code>grep</code>や<code>tail</code>
                のようなBashコマンドを使い、巨大なデータベースやログファイルの全体をコンテキストに載せることなく、ターゲットを絞ったクエリで分析を行います。
              </p>
              <p>
                エージェント的検索(agentic
              ...
              <ol>
                <li>
                  <strong>明確な目的(Objective)</strong>
                </li>
                <li>
                  <strong>出力フォーマット</strong>
                </li>
                <li>
                  <strong>使うべきツール・情報源のガイダンス</strong>
                </li>
                <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  SDKの<code>compact</code>
                  機能は会話履歴を自動的に要約します。あるベンダーの実務分析では、名目上200,000トークンのウィンドウに対し、実効的な作業コンテキストは60,000〜80,000トークン程度に留めることが推奨されています。SDKは
                  <code>PreCompact</code>
                  フックを公開しており、圧縮イベントを検知して独自のロジックを挟むことも可能です。
                </li>
              </ul>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Effective context engineering for AI agents — Anthropic Engineering(一次情報)
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Building agents with the Claude Agent SDK — Anthropic Engineering(一次情報)
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Subagents in the SDK — Claude API Docs(一次情報)
                    </a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      href="https://arxiv.org/pdf/2508.08322"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <section className={styles.docSection} id="sec-6">
              ...
              <div className={styles.diagramWrap}>
                ...
                <div className={styles.diagramCaption}>図10: Microsoft Agent Frameworkへの統合</div>
              </div>
                ...
                <ul>
                  ...
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Top Multi-Agent Orchestration Frameworks for 2026 — TrueFoundry
                    </a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Agent Framework overview — Microsoft Learn(一次情報)
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Multi-agent orchestration — OpenAI Agents SDK Docs(一次情報)
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Handoffs — OpenAI Agents SDK Docs(一次情報)
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <section className={styles.docSection} id="sec-7">
              ...
              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_11} />
                <div className={styles.diagramCaption}>図11: MCPとA2Aのレイヤー分担</div>
              </div>
              ...
              <p>
                A2Aプロトコルの中核機能の一つが<strong>Agent Card</strong>です。各エージェントは
                <code>/.well-known/agent-card.json</code>
                のような公開エンドポイントで自身の能力・認証要件・対応タスク種別を宣言し、他のエージェントはこれを読み取ることで「このエージェントに何を頼めるか」を実行時に判断できます。これにより、静的に事前登録された固定のエージェント一覧ではなく、動的なエージェントの発見と連携が可能になります。
              </p>
                ...
                <ul>
                  ...
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      What Is Google's Agent2Agent (A2A) Protocol? — Galileo AI
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Agent-to-Agent Communication Protocols in 2026 — Zylos AI Research
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      A2A Protocol Adoption in 2026 — Glukhov.org
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://atlan.com/know/google-a2a-protocol/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      What is Google's Agent2Agent Protocol (A2A)? — Atlan
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://www.ibm.com/think/topics/agent2agent-protocol"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Agent2Agent Protocol — IBM Think
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <section className={styles.docSection} id="sec-8">
              ...
              <p>
                ...
                は、7つの人気マルチエージェントフレームワーク・200件以上のタスクの軌跡(トレース)を分析し、
                <strong>MAST(Multi-Agent System Failure Taxonomy)</strong>
                という14種類の失敗モードを3つの大分類にまとめました。これは2026年時点でマルチエージェントの信頼性を議論する際の共通言語になっています。
              </p>

              <h3>8.1 3大分類と発生率</h3>
              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_12} />
                <div className={styles.diagramCaption}>
                  図12: MASTにおける失敗カテゴリの発生比率(概算)
                </div>
              </div>
              ...
              <div className={`${styles.callout} ${styles.calloutDanger}`}>
                論文の著者らは、既存の介入策(改善されたプロンプト設計・より明確な役割仕様など)がFM-1.1や検証関連の失敗を実質的に減らせることを示す一方で、
                <strong>
                  MASの性能向上は依然として人気ベンチマークにおいて最小限にとどまっている
                </strong>
                とも指摘しており、「マルチエージェント化すれば自動的に賢くなる」という前提そのものへの警鐘となっています。
              </div>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Why Do Multi-Agent LLM Systems Fail? — arXiv:2503.13657(一次情報/論文)
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://arxiv.org/pdf/2601.17915"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Multi-Agent System Failure Taxonomy(詳細版PDF)— arXiv:2601.17915
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Agent Failure Modes: A Practical Guide — Galileo AI
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Why Do Multi-Agent LLM Systems Fail?(要約と論評)— Future AGI
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <section className={styles.docSection} id="sec-9">
              ...
              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_13} />
                <div className={styles.diagramCaption}>
                  図13: 連鎖的プロンプトインジェクションのリスク経路
                </div>
              </div>
              ...
              <div className={styles.tableWrap}>
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <strong>最小権限の原則(Least Privilege)</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>入力のサニタイズとコンテキスト境界の明示</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>人間承認ゲート(Human-in-the-loop)</strong>
                      </td>
                      <td>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      AI App Security 2026: Prompt Injection & Guardrails — Webyot
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      The Complete AI Guardrails Implementation Guide for 2026 — Maxim AI
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Multi-Agent AI Security Risks, Compliance & Fixes — Augment Code
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <section className={styles.docSection} id="sec-10">
              ...
              <p>
                単一のログ行ではなく、「どのエージェントが」「どの時点で」「どのツールを」「どんな理由で」呼び出したかという
                <strong>因果関係を含んだトレース</strong>を記録する必要があります。
              </p>
              ...
              <div className={styles.tableWrap}>
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <strong>OpenTelemetry(OTel)ベースの自作基盤</strong>
                      </td>
                      <td>
              ...
              <ul>
                <li>
                  <strong>タスク完了率</strong>: エンドツーエンドでタスクが正しく完了したか
                </li>
                <li>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      Best AI Agent Observability Tools 2026 — Confident AI
                    </a>
                  </li>
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      AI Agent Observability with Langfuse — Langfuse Blog(一次情報)
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <section className={styles.docSection} id="sec-11">
              ...
              <p>
                4.2節で見た通り、マルチエージェントシステムは通常のチャット対話の
                <strong>約15倍</strong>
                のトークンを消費します。この経済性を無視した設計は、本番運用でのコスト超過に直結します。
              </p>

              <h3>11.1 コスト構造の可視化</h3>
              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_15} />
                <div className={styles.diagramCaption}>図15: マルチエージェントのコスト構造</div>
              </div>
              ...
              <div className={styles.tableWrap}>
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <strong>モデルルーティング(Model Routing)</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>トークン予算の強制(Budget Enforcement)</strong>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <strong>コンテキストの圧縮・要約(5.5節参照)</strong>
                      </td>
                      <td>
              ...
              <ul>
                <li>
                  このタスクは本当に<strong>独立した並列探索</strong>
                  を必要とするか(依存関係が強いタスクなら並列化のコストが正当化されない)
                </li>
                <li>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      AI Agent Cost Optimization & Token Economics — Zylos AI Research
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      ...
                      Caching — Harness Engineering Academy
                    </a>
                  </li>
                  <li>
                    <a
            ...
            <section className={styles.docSection} id="sec-12">
              ...
              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_16} />
                <div className={styles.diagramCaption}>
                  図16: マルチエージェント採用の意思決定フロー
                </div>
              </div>
            ...
            <section className={styles.docSection} id="sec-13">
              ...
              <div className={styles.diagramWrap}>
                <MermaidDiagram chart={MMD_17} />
                <div className={styles.diagramCaption}>図17: 実装の8ステップ</div>
              </div>
              ...
              <div className={styles.codeBody}>
                ...
                <div className={styles.codeLine}>
                  <span className={styles.ck}>subagent_contract</span> = &#123;
                </div>
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cs}>&quot;objective&quot;</span>:{" "}
                  <span className={styles.cv}>
                    &quot;2025年〜2026年における半導体サプライチェーンの構造変化を調査する&quot;
                  </span>
                  ,
                </div>
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cs}>&quot;output_format&quot;</span>: &#123;
                </div>
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cs}>&quot;summary&quot;</span>:{" "}
                  <span className={styles.cv}>&quot;文字数600字以内の要約&quot;</span>,
                </div>
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cs}>&quot;key_findings&quot;</span>:{" "}
                  <span className={styles.cv}>&quot;箇条書き5件以内&quot;</span>,
                </div>
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cs}>&quot;sources&quot;</span>:{" "}
                  <span className={styles.cv}>&quot;出典URLのリスト&quot;</span>,
                </div>
                <div className={styles.codeLine}> &#125;,</div>
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cs}>&quot;tool_guidance&quot;</span>: [
                </div>
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cv}>
                    &quot;web_search を優先し、一次情報(企業IR・政府統計)を web_fetch
                    で深掘りする&quot;
                  </span>
                  ,
                </div>
                ...
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cs}>&quot;boundaries&quot;</span>: [
                </div>
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cv}>
                ...
                <div className={styles.codeLine}>
                  {" "}
                  <span className={styles.cv}>&quot;個別企業の株価予測は行わない&quot;</span>,
                </div>
                <div className={styles.codeLine}> ],</div>
                <div className={styles.codeLine}>&#125;</div>
              </div>
              ...
              <div className={styles.codeBody}>
                <div className={styles.codeLine}>
                  <span className={styles.ck}>orchestrator_scaling_rules</span> ={" "}
                ...
                <div className={styles.codeLine}>
                  <span className={styles.cg}>- 単純な事実確認:</span>{" "}
                  <span className={styles.cv}>1エージェント、3〜10回のツール呼び出し</span>
                </div>
                <div className={styles.codeLine}>
                  <span className={styles.cg}>- 直接比較(2〜3項目):</span>{" "}
                  <span className={styles.cv}>
                    2〜4サブエージェント、各10〜15回のツール呼び出し
                  </span>
                </div>
                <div className={styles.codeLine}>
                  <span className={styles.cg}>- 複雑な多面的調査:</span>{" "}
                  <span className={styles.cv}>10以上のサブエージェント、明確な役割分担を伴う</span>
                </div>
                <div className={styles.codeLine}>
            ...
            <section className={styles.docSection} id="sec-14">
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        将来的な他社エージェントとの連携を見据え、MCP・A2Aへの対応を検討したか
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <ol>
                ...
                <li>
                  <strong>
                    トポロジーの選択は、制御の集中度とレイテンシ・コストのトレードオフである
                  </strong>
                  。5〜6の代表パターンから、タスク特性に応じて選ぶ。
                </li>
                <li>
                  <strong>
                    失敗は「モデルの賢さ」ではなく「仕様と検証の設計」に起因することが多い
                  </strong>
                  。MASTの14の失敗モードは、その大半がプロンプト設計・アーキテクチャ設計で予防可能であることを示している。
                </li>
                <li>
                  <strong>
                    コスト・セキュリティ・可観測性は、後付けではなく設計の最初から組み込む
                  </strong>
              ...
              <ul>
                ...
                <li>
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    https://arxiv.org/pdf/2601.17915
                  </a>
                  (MAST詳細版)
                </li>
                <li>
                ...
                <li>
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    https://arxiv.org/pdf/2508.08322
                  </a>
