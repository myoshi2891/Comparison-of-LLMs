  ...
  return (
    <div className={styles.layout}>
      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.toc}>
          <a href="#step1" className={styles.tocLink}>
            <i className="ti ti-number-1" />
            ギャップの特定
          </a>
          <a href="#step2" className={styles.tocLink}>
            <i className="ti ti-number-2" />
            ディレクトリ設計
          </a>
          <a href="#step3" className={styles.tocLink}>
            <i className="ti ti-number-3" />
            フロントマター
          </a>
          <a href="#step4" className={styles.tocLink}>
            <i className="ti ti-number-4" />
            description設計
          </a>
          <a href="#step5" className={styles.tocLink}>
            <i className="ti ti-number-5" />
            本文を簡潔に書く
          </a>
          <a href="#step6" className={styles.tocLink}>
            <i className="ti ti-number-6" />
            分割パターン
          </a>
          <a href="#step7" className={styles.tocLink}>
            <i className="ti ti-number-7" />
            ワークフロー設計
          </a>
          <a href="#step8" className={styles.tocLink}>
            <i className="ti ti-number-8" />
            Claude Code固有フィールド
          </a>
          <a href="#step9" className={styles.tocLink}>
            <i className="ti ti-number-9" />
            実行コードの設計
          </a>
          <a href="#step10" className={styles.tocLink}>
            <i className="ti ti-number-10" />
            セキュリティ
          </a>
          <a href="#step11" className={styles.tocLink}>
        ...
        <nav className={styles.toc}>
          <a href="#antipatterns" className={styles.tocLink}>
          ...
          <a href="#sources" className={styles.tocLink}>
      ...
      <main className={styles.main}>
        ...
        <section id="step10" className={styles.section}>
          ...
          <p>
            Skillはコードを実行し、ツールを呼び出す能力を持つため、公式ドキュメントは「信頼できる作成元(自作またはAnthropic提供)のSkillのみを使う」ことを強く推奨している。信頼できない出どころのSkillを使ざるを得ない場合は、以下を確認する。
          </p>
          <ul>
