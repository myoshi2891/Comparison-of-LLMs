          ...
          <section id="overview" className={`${styles.section} chapter`}>
            ...
            <div className={styles.prose}>
              ...
              <p>
                ...
                Codeの延長線上にある進化」と位置づけており、社内では製品チーム of
                コードの65%がClaude Tagの内部版によって生成されているとされています。
              </p>
            ...
            <div className={styles.prose}>
              ...
              <ul>
                ...
                <li>
                  ...
                  チャンネル内でのClaudeの行動は、タグ付けした個人のアカウントではなく、管理者が発行した専用
                  of サービスアカウント(Slackアプリ・GitHub
