      ...
      <args>0</args>   <!-- 第1引数が汚染チェック対象 -->
        ...
        <section id="ch9" className={styles.chapterSection}>
          <div className={styles.container}>
            ...
            <p className={styles.paragraph}>
              <strong>2026.3 の新機能：</strong> SonarQube Server 2026.3 以降は MCP
              サーバーを<strong>本体に組み込み（embedded MCP server）</strong>でホストできるようになった。
              従来の Docker コンテナを個別に起動する方式に加え、単一の MCP サーバー URL を指定するだけで
              AI コーディングアシスタントを接続でき、インフラ管理のオーバーヘッドが削減される。
            </p>
