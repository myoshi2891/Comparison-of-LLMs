      ...
      <div className={styles.pageContainer}>
        ...
        <main className={styles.main}>
          ...
          <article className={styles.prose}>
            ...
            <p>
              2026年2月、OpenAIはエンジニアリングブログで「Harness engineering: leveraging Codex in
              an agent-first world」という記事を公開した。著者はOpenAIのRyan
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr className="odd">
                    ...
                    <td>
                      最終出力をJSON
                      Schemaに準拠させ、severityなどのフィールドで自動採点しやすくする
                    </td>
                  </tr>
                  <tr className="even">
                    <td>
            ...
            <p>
              ...
              <code>report.md</code> に加え、<code>findings.json</code> や{" "}
              <code>coverage.json</code>{" "}
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr className="even">
                    ...
                    <td>
                      Golden Principles + 背景クリーンアップエージェントによる日次の小さな返済
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className={styles.refGrid}>
              ...
              <div className={styles.refCard}>
                ...
                <ul>
                  <li>
                    InfoQ. &quot;OpenAI Introduces Harness Engineering: Codex Agents Power
                  ...
                  <li>
                    The Decoder. &quot;OpenAI open-sources Codex Security CLI to help developers
                    find and fix vulnerabilities from the command line.&quot; —{" "}
                    <Ext href="https://the-decoder.com/openai-open-sources-codex-security-cli-to-help-developers-find-and-fix-vulnerabilities-from-the-command-line/">
                      &nearr;
