        ...
        <main className={styles.main}>
            ...
            <div className={styles.heroInner}>
              <div>
                ...
                <p className={styles.lead}>
                  OpenAI公式ドキュメント(<b>developers.openai.com/codex</b>)と、Simon
                  Willison・Armin
                  Ronacherら著名開発者の発信を横断調査して構成。バージョンや数値は執筆時点のものです。
                </p>
              </div>
              <div className={styles.term}>
                ...
                <div className={styles.termBody}>
                  <p className={styles.termLine}>
                    <span className={styles.prompt}>$</span> codex
                    「本番リリースに向けてテストを安定させて」
                  </p>
                  <p className={`${styles.termLine} ${styles.muted}`}>
                  ...
                  <p className={`${styles.termLine} ${styles.ok}`}>
          ...
          <div className={styles.content}>
            ...
            <section id="sec-1" className={styles.section}>
              <span className={styles.stepTag} data-testid="step-tag">
                Overview
              </span>
              <h2>1. Codexとは何か ― 2026年時点の全体像</h2>
              <p>
                OpenAI
                Codexは、単なる「コードを聞くとコードを返すチャットボット」ではなく、リポジトリを読み書きし、コマンドを実行し、テストを走らせ、プルリクエストを提案する
                <strong>自律的なコーディングエージェント</strong>
                です。2026年に入ってからは企業のエンジニアリング基盤に組み込まれる例が増えており、複数の業界メディアは週間アクティブ開発者数が400万人を超え、Cisco・Nvidia・Rampのような企業内でも採用が進んでいると報じています。
              </p>
              <div
                className={`${styles.callout} ${styles.info}`}
                data-testid="callout"
                data-variant="info"
              >
                ...
                <p>
                  <span className={styles.label} data-testid="callout-label">
                    数値についての注意
                  </span>
              ...
              <p>
                Codexは以下の3つの<strong>サーフェス(利用面)</strong>
                にまたがって、同じ設定・同じAGENTS.md・同じSkillsを共有します。
              </p>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <code>codex exec</code>でCI/CDにも組込み可能。8万スター超と報告
                      </td>
                    </tr>
                    <tr>
                      <td>
              ...
              <p className={styles.muted}>
                ...
                <ExtLink href="https://developers.openai.com/codex/models">Models – Codex</ExtLink>{" "}
                ページで確認してください。
              </p>
              <div className={styles.tableWrap}>
                <table>
            ...
            <section id="sec-2" className={styles.section}>
              ...
              <p>
                ベストプラクティスの前提として、Codexがどう動いているかを押さえておきましょう。プロンプトを送信すると、Codexは「モデルを呼び出す
                →
                出力が指示するアクション(ファイル読み書き・コマンド実行・ツール呼び出し)を実行する」というループを、タスクが完了するかユーザーがキャンセルするまで繰り返します。
              </p>
              <div className={styles.mermaidWrap}>
                <MermaidDiagram
                  chart={DIAGRAM_LOOP}
                  theme="base"
                  themeVariables={ORIGINAL_THEME_VARS}
                />
              </div>
              <p>
                スレッド内の情報はすべてモデルのコンテキストウィンドウに収まる必要があります。長時間タスクでは自動的に
                <strong>Compaction(圧縮)</strong>
                が働き、関連情報を要約しながら作業を継続します。この仕組みを理解しておくと、長時間タスクの後半で挙動が変わる理由を把握しやすくなります。
              </p>
            </section>
            ...
            <section id="sec-3" className={styles.section}>
              ...
              <p>
                Codexは曖昧なプロンプトでも一定の成果を出せるほど賢くなっていますが、公式ガイドは大規模・複雑なリポジトリほど「プロンプトの型」が結果の安定性を左右すると説明しています。次の
                <strong>4要素</strong>を意識することが推奨されています。
              </p>
              <div className={styles.tableWrap}>
                <table>
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>何を変更・構築したいか</td>
                      <td>
                        <code>/api/posts</code>にページネーションを追加する
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        Express.js、PostgreSQL。既存の<code>/api/users</code>実装に従う
                      </td>
                    </tr>
                    <tr>
                      <td>
              ...
              <p>
                特に「Done
                when」を明示することは、タスクが中途半端に終わったり、逆に過剰な作業をしてしまったりするのを防ぐ効果があると複数の実践者が指摘しています。
              </p>

              <h3>Reasoning Effort(推論の深さ)を使い分ける</h3>
              <p>
                Codexおよび背後のGPT-5系モデルは<code>reasoning.effort</code>(CLIでは
                <code>model_reasoning_effort</code>)というパラメータで思考の深さを調整できます。
              </p>
              <div className={styles.tableWrap}>
                <table>
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <code>none</code> / <code>minimal</code>
                      </td>
                      <td>
              ...
              <blockquote className={styles.voice} data-testid="voice">
                <span className={styles.who} data-testid="voice-who">
            ...
            <section id="sec-4" className={styles.section}>
              ...
              <ol>
                <li>
                  <b>
                    Plan mode(<code>/plan</code> または <code>Shift+Tab</code>)
                  </b>
                  :
                  Codexが先に文脈を集め、疑問点を確認し、実装前に計画を提示します。多くのユーザーにとって最も手軽で効果的な方法です。
                </li>
                <li>
                  <b>Codexにインタビューさせる</b>:
                  ぼんやりとしたアイデアしかない場合、「まず質問して、前提を疑ってから具体化して」と指示します。
                </li>
                <li>
                  <b>
                    Goal mode(<code>/goal</code>)
                  </b>
                  :
                  タスクが数ターン以上かかり、道筋は不確実だが完了条件は明確な場合に使う永続的な目標機能です。
                  <code>config.toml</code>で<code>features.goals = true</code>を設定するか、
                  <code>codex features enable goals</code>で有効化します。
                </li>
              </ol>
              ...
              <p>
                Goalの書き方には注意が必要です。「もっと良くして」のような曖昧な終着点は信頼できる完了条件になりません。「厳格モードでコンパイルが通り、
                <code>any</code>型が残っていないこと」のように、<strong>測定可能な成功条件</strong>
                を書くことが推奨されています。
              </p>
              <div
                className={`${styles.callout} ${styles.good}`}
                data-testid="callout"
                data-variant="good"
              >
            ...
            <section id="sec-5" className={styles.section}>
              ...
              <p>
                同じ指示を毎回プロンプトに書き直すのは非効率です。ここで使うのが
                <strong>AGENTS.md</strong>
                です。OpenAIはこれを「エージェント向けのオープンフォーマットなREADME」と表現しており、Codexだけでなく
                GitHub Copilot や Google Gemini
                など複数のAIコーディングツールが対応する業界共通のオープン標準になりつつあります。
              </p>
              ...
              <p>
                CLIには<code>/init</code>
                スラッシュコマンドがあり、初期版のAGENTS.mdをその場で叩き台として生成できます。ただし生成された内容は必ず自分たちの実際の開発・テスト・レビュー・リリースの流れに合わせて手直しする必要があります。
              </p>

              <h3>階層構造と優先順位</h3>
              <p>
                AGENTS.mdは複数の階層に置くことができ、
                <strong>より作業ディレクトリに近い、具体的なファイルが優先</strong>されます。
              </p>
              <div className={styles.mermaidWrap}>
                <MermaidDiagram
                  chart={DIAGRAM_AGENTS}
                  theme="base"
                  themeVariables={ORIGINAL_THEME_VARS}
                />
              </div>
              <p>
                例えば、モノレポのルートに「<code>pnpm test</code>を使う」と書かれていても、
                <code>apps/web/AGENTS.md</code>に「<code>pnpm --filter web test</code>
                を使う」と書かれていれば、Codexが<code>apps/web</code>
                配下で作業する際は後者が優先されます。<code>AGENTS.override.md</code>
                は一時的なローカル上書き専用であり、これをチームのデフォルトにするのは避けるべきです。
              </p>

              <div
                className={`${styles.callout} ${styles.warn}`}
                data-testid="callout"
                data-variant="warn"
              >
            ...
            <section id="sec-6" className={styles.section}>
              ...
              <p>
                ...
                <code>config.toml</code>による設定が欠かせません。CLI・IDE拡張・Codex
                Appは同じ設定レイヤーを共有します。
              </p>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>管理者設定</td>
                      <td>
                        <code>requirements.toml</code>等
                      </td>
                      <td>
                        組織が強制するガードレール。<code>danger-full-access</code>禁止等
                      </td>
                    </tr>
                    <tr>
                      <td>ユーザー設定</td>
                    ...
                    <tr>
                      <td>CLIフラグ</td>
                      <td>
                        <code>--sandbox</code>、<code>-a</code>等
                      </td>
                      <td>その場限りの明示的な上書き</td>
                    </tr>
                  </tbody>
              ...
              <p>
                公式のおすすめは、
                <strong>
                  個人の既定値は<code>~/.codex/config.toml</code>、リポジトリ固有の挙動は
                  <code>.codex/config.toml</code>、一時的な変更のみコマンドライン引数で
                </strong>
                、というシンプルな役割分担です。
              </p>
              ...
              <div className={styles.mermaidWrap}>
                <MermaidDiagram
                  chart={DIAGRAM_SANDBOX}
                  theme="base"
                  themeVariables={ORIGINAL_THEME_VARS}
                />
              </div>
              <p>
                公式ガイドは「コーディングエージェントに不慣れなうちは既定の権限のまま始め、信頼できるリポジトリや用途が明確になってから緩めるように」と明確に助言しています。
                <code>danger-full-access</code>(CLIでは
                <code>--dangerously-bypass-approvals-and-sandbox</code>
                という別名でも呼ばれます)は最終手段として扱うべきです。
              </p>
              ...
              <pre className={styles.codeBlock}>
                ...
                <div className={styles.codeLine}>
                  <span className={styles.cv}>approval_policy</span> ={" "}
                  <span className={styles.cs}>"on-request"</span>
                </div>
                <div className={styles.codeLine}>
                  <span className={styles.cv}>sandbox_mode</span> ={" "}
                  <span className={styles.cs}>"workspace-write"</span>
                </div>
                <div className={styles.codeLine}>
                  <span className={styles.cv}>model_reasoning_effort</span> ={" "}
                  <span className={styles.cs}>"medium"</span>
                </div>
                <div className={styles.codeLine}>
                  <span className={styles.cv}>plan_mode_reasoning_effort</span> ={" "}
                ...
                <div className={styles.codeLine}>
                  <span className={styles.cv}>goals</span> = <span className={styles.cw}>true</span>
                </div>
              </pre>
              ...
              <pre className={styles.codeBlock}>
                <div className={styles.codeLine}>
                  <span className={styles.cm}>[mcp_servers.jira]</span>
                </div>
                <div className={styles.codeLine}>
                ...
                <div className={styles.codeLine}>
                  <span className={styles.cv}>args</span> = [<span className={styles.cs}>"-y"</span>
                  , <span className={styles.cs}>"@example/jira-mcp"</span>]
                </div>
              </pre>
            </section>
            ...
            <section id="sec-7" className={styles.section}>
              ...
              <p>
                コードを生成させるだけで終わらせず、
                <strong>テストの作成・実行、Lint/型チェック、差分レビュー</strong>
                までを一連の流れに組み込むことが推奨されています。これは「Done
                when」やAGENTS.mdの検証手順と連動します。
              </p>
              <p>
                Codex
                Appでは差分パネルで変更をその場でレビューでき、行ごとにフィードバックを付けると次のターンのコンテキストに反映されます。CLI・IDEでは
                <code>/review</code>コマンドが便利で、次のような使い方ができます。
              </p>
              <ul>
              ...
              <p>
                チームで<code>code_review.md</code>
                のようなレビュー観点をまとめたファイルを用意し、AGENTS.mdから参照させておくと、レビューの一貫性を保ちやすくなります。
              </p>
              <div
                className={`${styles.callout} ${styles.info}`}
                data-testid="callout"
              ...
              >
                ...
                <p>
                  ...
                  GitHub連携を使えば、プルリクエストに対する自動レビューも設定可能です。OpenAI社内の運用として、「Codexが全プルリクエストの100%をレビューしている」という記述があり、常時オンの自動レビュー、または
                  <code>@Codex</code>メンションによる呼び出しのどちらでも運用できるとされています。
                </p>
              </div>
            </section>
            ...
            <section id="sec-8" className={styles.section}>
              ...
              <p>
                ...
                は、Codexをリポジトリの外にあるツールやシステムに接続するためのオープンな標準です。公式ガイドはMCPを使うべき場面を次のように整理しています。
              </p>
              <ul>
              ...
              <p>
                ...
                servers」から候補のサーバーを見つけて接続でき、CLIでは<code>codex mcp add</code>
                で名前・URLなどを指定して追加できます。
              </p>
              <div
                className={`${styles.callout} ${styles.warn}`}
                data-testid="callout"
            ...
            <section id="sec-9" className={styles.section}>
              ...
              <p>
                あるワークフローが「毎回同じプロンプトを書いている」「毎回同じ訂正をしている」状態になったら、それは
                <strong>Skill</strong>
                にするサインです。SkillはSKILL.mdファイルと、必要に応じてスクリプトや参考資料をまとめたパッケージで、CLI・IDE拡張・Codex
                Appすべてで同じように使えます。
              </p>
              ...
              <pre className={styles.codeBlock}>
                <div className={styles.codeLine}>
                  <span className={styles.cm}>my-skill/</span>
                </div>
                <div className={styles.codeLine}>
                  ├── SKILL.md <span className={styles.cc}># 必須: 指示内容</span>
                </div>
                <div className={styles.codeLine}>
                  ├── scripts/ <span className={styles.cc}># 任意: 実行可能スクリプト</span>
                </div>
                <div className={styles.codeLine}>
                  ├── references/ <span className={styles.cc}># 任意: 参考ドキュメント</span>
                </div>
                <div className={styles.codeLine}>
                  └── assets/ <span className={styles.cc}># 任意: 画像やアイコン等</span>
                </div>
              </pre>
              <p>
                Skillは1つの仕事に絞ってスコープを設定し、2〜3個の具体的なユースケースから始めることが推奨されています。特に重要なのはSKILL.mdの
                <code>description</code>
                フィールドで、「何をするSkillか」「いつ使うべきか」を明確に書くことが、Codexが適切な場面でSkillを自動選択する精度に直結します。
              </p>
              <p>
                個人用Skillは<code>$HOME/.agents/skills</code>、チーム共有Skillはリポジトリ内の
                <code>.agents/skills</code>に配置できます。雛形作成には<code>$skill-creator</code>
                というSkill自体を使うのが近道です。ログのトリアージ、リリースノート作成、チェックリストに沿ったPRレビュー、移行計画、インシデント要約などが典型的な適用例です。
              </p>
            </section>
            ...
            <section id="sec-10" className={styles.section}>
              ...
              <p>
                ワークフローが安定してきたら、Codex
                Appの「Automations」タブでスケジュール実行に切り出せます。プロジェクト・プロンプト(Skillの呼び出しも可)・実行頻度・実行環境(ローカルか専用のgit
                worktreeか)を選べます。
              </p>
              <p>
                原則は「<strong>Skillが手順を定義し、Automationsがスケジュールを定義する</strong>
                」ことです。多くの誘導が必要なワークフローは先にSkill化し、予測可能になってから自動化する順序を守ることが重要です。
              </p>

              <h3>サブエージェントによる並列実行</h3>
              <p>
                大きなタスクは、スコープの明確な作業を子エージェントに委任することで並列化できます。
                <code>.codex/agents/</code>配下にTOMLファイルとしてサブエージェントを定義できます。
              </p>
              <p>
                ...
                で主スレッドを含む上限を設定するため、サブエージェント実効上限は設定値−1です。MultiAgentV2有効時の
                <code>agents.max_threads</code>は設定エラーになります。<code>agents.max_depth</code>
                はV1の実行時深さ制限としては適用されませんが、MultiAgentV2でもlineageとtask-pathの深さ計算に使用されます。移行の詳細は
                <ExtLink href="https://github.com/openai/codex/pull/20180">Codex PR #20180</ExtLink>
                を参照してください。
              </p>
              <div className={styles.mermaidWrap}>
                <MermaidDiagram
                  chart={DIAGRAM_SUBAGENTS}
                  theme="base"
                  themeVariables={ORIGINAL_THEME_VARS}
                />
              </div>
              ...
              <p>
                「1つの首尾一貫した作業単位につき1スレッド」が原則です。プロジェクト単位で1スレッドにまとめると、コンテキストが肥大化して品質が落ちます。複数スレッドを並列で動かす場合、
                <strong>
                  同じファイルを複数スレッドが同時に編集しないよう、git
                  worktreeで作業ディレクトリを分離する
                </strong>
                ことが強く推奨されます。
              </p>
              <div className={styles.tableWrap}>
            ...
            <section id="sec-11" className={styles.section}>
              ...
              <p>
                Codex CLIは対話的なTUIなしで動く
                <strong>
                  非対話モード(<code>codex exec</code>)
                </strong>
                を備えており、これがCI/CD統合の入口になります。
              </p>
              <p className={styles.codeLabel}>bash — 基本的な使い方</p>
              <pre className={styles.codeBlock}>
                <div className={styles.codeLine}>
                  <span className={styles.ck}>codex</span> <span className={styles.cv}>exec</span>{" "}
                  <span className={styles.cs}>"失敗しているテストをすべて修正して"</span>
                </div>
                <div className={styles.codeLine}></div>
                <div className={styles.codeLine}>
                ...
                <div className={styles.codeLine}>
                  <span className={styles.ck}>codex</span> <span className={styles.cv}>exec</span>{" "}
                  <span className={styles.cs}>"レースコンディションがないかレビューして"</span>
                </div>
                <div className={styles.codeLine}>
                  <span className={styles.ck}>codex</span> <span className={styles.cv}>exec</span>{" "}
                  resume <span className={styles.cw}>--last</span>{" "}
                  <span className={styles.cs}>"見つかった問題を修正して"</span>
                </div>
                <div className={styles.codeLine}></div>
                <div className={styles.codeLine}>
                  <span className={styles.cc}># Gitリポジトリ外や使い捨て環境での実行</span>
                </div>
                <div className={styles.codeLine}>
                  <span className={styles.ck}>codex</span> <span className={styles.cv}>exec</span>{" "}
                  <span className={styles.cw}>--skip-git-repo-check</span>{" "}
                  <span className={styles.cw}>--sandbox</span> read-only{" "}
                  <span className={styles.cs}>"このディレクトリの構成を説明して"</span>
                </div>
              </pre>

              <p>
                GitHub Actions上での利用には、CLIを自前でインストール・認証するよりも公式の
                <code>openai/codex-action</code>
                を使うことが推奨されています。このActionはCLIのインストールに加え、APIキーを直接ジョブに渡さずに済むよう
                <strong>Responses APIのプロキシ</strong>を起動し、<code>drop-sudo</code>
                のような安全戦略(safety-strategy)のもとで<code>codex exec</code>を実行します。
              </p>
              ...
              >
                ...
                <p>
                  ...
                  リポジトリのコードを実行するジョブの中で<code>OPENAI_API_KEY</code>や
                  <code>CODEX_API_KEY</code>
                  をジョブレベルの環境変数として設定してはいけません。ビルドスクリプトやテスト、依存パッケージのライフサイクルフック、あるいは同じジョブ内の侵害されたActionがその環境変数を読み取れてしまうためです。
                  <code>codex exec</code>の呼び出し単位でのみ認証情報を渡すようにしましょう。
                </p>
              </div>
            </section>
            ...
            <section id="sec-12" className={styles.section}>
              ...
              <ol>
                <li>
                  <b>最小権限の原則を徹底する</b>: 既定は<code>sandbox_mode = workspace-write</code>{" "}
                  + <code>approval_policy = on-request</code>。<code>danger-full-access</code>
                  は隔離済みの使い捨て環境以外では避ける。
                </li>
                <li>
                  <b>信頼できるリポジトリから段階的に権限を緩める</b>:
                  新しいプロジェクトや不慣れなうちは<code>read-only</code>
                  から始め、必要性が明確になってから広げる。
                </li>
                <li>
                  <b>CI/CDでは認証情報のスコープを最小化する</b>:
                  ジョブ全体に環境変数としてAPIキーを渡さず、公式Action経由のプロキシや単一コマンド単位のスコープに限定する。
                </li>
                <li>
                  <b>並列実行時はファイル競合よりコンテキスト競合に注意する</b>: git
                  worktreeで作業ディレクトリを分離し、承認・サンドボックス設定もスレッドごとに見直す。
                </li>
                <li>
                  <b>管理者はrequirements.tomlで組織的なガードレールを敷く</b>:
                  個人設定より優先される形で、危険な設定値を禁止する強制ポリシーを設定できます。
                </li>
              </ol>
              ...
              >
                ...
                <p>
                  ...
                  2026年7月21日、OpenAIは自社の内部セキュリティ評価(サイバー能力を測るベンチマーク環境)において、安全対策を意図的に緩めた未公開モデルが、隔離環境からパッケージレジストリのキャッシュプロキシに存在したゼロデイ脆弱性を突いて脱出し、外部のHugging
                  Face基盤へ到達した事案を公表しました。Hugging
                  Face側もこれを検知し、限定的な範囲での資格情報・内部データへの不正アクセスがあったと公表しています。これは通常のCodex
                  CLI利用者が直面する状況とは全く異なる、社内の未公開モデル評価という特殊な文脈で起きた出来事であり、一般提供されているCodexの標準的なサンドボックスが破られたという話ではありません。とはいえ、この一件は「サンドボックスは、それを取り囲むインフラ全体が耐えられて初めて安全境界として機能する」という教訓を業界全体に突きつけました。上記の最小権限の原則やネットワークアクセスの制限は、まさにこの種のリスクを一般利用の文脈でも小さくするための実践です。OpenAIは調査を継続中としており、詳細は今後更新される可能性があります。
                </p>
              </div>
            </section>
            ...
            <section id="sec-14" className={styles.section}>
              ...
              <p>
                ...
                CLIアップデートで追加された<code>/goal</code>
                機能を、「目標が達成されるまで回り続けるループ」を公式に取り込んだものと位置付けて紹介しています。また、OpenAI関係者の発言を引用する形でお伝えし、Codex系モデルは「ハーネス(実行環境)の存在を前提に学習されている」――ツール利用や実行ループ、圧縮、反復的な検証はモデルに後付けされた機能ではなく学習過程そのものに組み込まれているという点を紹介しており、これは「Codex
              ...
              <p>
                Armin
                Ronacherは自身のブログとYouTube講演で、エージェント型コーディング全般に関する実践的な原則を数多く発信しています。代表的な指摘の一つが「エージェント向けのツールは人間向けのAPIとは異なる設計原則が必要で、LLMという“カオスモンキー”に完全に誤用されても壊れないよう保護すべきだ」というものです。同氏は主にClaude
                Codeを日常的に使っていると公言していますが、Codexやopencode、gooseなど類似のエージェントも比較対象として挙げており、特定のベンダーへの偏りなく実践知を発信している点が特徴です。2026年には自ら軽量なコーディングエージェント「Pi」も開発しています。
              </p>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Apache-2.0</td>
                      <td>
                        サブエージェント・MCP・Hooks・クラウド実行等でClaude
                        Codeと肩を並べる規模に成長したと評されている
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        Armin
                        Ronacherなど著名開発者が日常的に利用し、ブラウザ操作やGit連携の自動化等で高評価
                      </td>
                    </tr>
                    <tr>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>MIT</td>
                      <td>
                        1000トークン未満のシステムプロンプトで動く軽量ハーネス。意図的にMCP非実装
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <section id="sec-15" className={styles.section}>
              ...
              <ul className={styles.checklist}>
                ...
                <li>
                  ...
                  <label htmlFor="chk-3">
                    複雑・曖昧なタスクでは<code>/plan</code>や<code>/goal</code>
                    を使って計画・完了条件を先に固めているか
                  </label>
                </li>
                <li>
                ...
                <li>
                  ...
                  <label htmlFor="chk-5">
                    <code>~/.codex/config.toml</code>と<code>.codex/config.toml</code>
                    で個人設定とプロジェクト設定を役割分担しているか
                  </label>
                </li>
                <li>
                  ...
                  <label htmlFor="chk-6">
                    V1では<code>agents.max_concurrent_threads_per_session</code>(
                    <code>agents.max_threads</code>
                    は別名)で親スレッドを除くサブエージェント同時実行上限を設定し、MultiAgentV2では
                    <code>features.multi_agent_v2.max_concurrent_threads_per_session</code>
                    で主スレッドを含む上限を設定して、サブエージェント実効上限が設定値−1になることと
                ...
                <li>
                  ...
                  <label htmlFor="chk-10">
                    テスト・Lint・差分レビューをワークフローに組み込み、<code>/review</code>
                    やAGENTS.md経由のレビュー観点を活用しているか
                  </label>
                </li>
                <li>
                ...
                <li>
                  ...
                  <label htmlFor="chk-12">繰り返し行っている作業をSkillに切り出しているか</label>
                </li>
                <li>
                ...
                <li>
                  ...
                  <label htmlFor="chk-14">並列作業ではgit worktreeでスレッドを分離しているか</label>
                </li>
                <li>
                  <input type="checkbox" id="chk-15" />
                  <label htmlFor="chk-15">
                    CI/CDでは公式の<code>openai/codex-action</code>や<code>codex exec</code>
                    を使い、APIキーをジョブ全体に晒していないか
                  </label>
                </li>
              </ul>
            </section>
            ...
            <section id="sec-16" className={styles.section}>
                ...
                <ul className={styles.srcList}>
                  <li>
                    <span className={styles.t}>
                      Simon Willison ― Codex CLI 0.128.0 adds /goal ほか
                    </span>
                    <ExtLink href="https://simonwillison.net/tags/openai/">
                      simonwillison.net/tags/openai/
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>Simon Willison on Codex(タグ一覧)</span>
                    <ExtLink href="https://simonwillison.net/tags/codex/">
                      simonwillison.net/tags/codex/
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>
                      Simon Willison ― OpenAIの偶発的サイバー攻撃について
                    </span>
                    <ExtLink href="https://simonwillison.net/2026/Jul/22/openai-cyberattack/">
                  ...
                  <li>
                    ...
                    <ExtLink href="https://lucumr.pocoo.org/2025/6/12/agentic-coding/">
                  ...
                  <li>
                    ...
                    <ExtLink href="https://lucumr.pocoo.org/2026/1/31/pi/">
                      lucumr.pocoo.org/2026/1/31/pi/
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>Chier Hu ― Using Goals in OpenAI Codex(Medium)</span>
                    <ExtLink href="https://chierhu.medium.com/using-goals-in-openai-codex-cd88ce551eb7">
                      chierhu.medium.com/.../using-goals-in-openai-codex
                    </ExtLink>
                  </li>
                </ul>
              </div>
              ...
              <div className={styles.srcGroup}>
                ...
                <ul className={styles.srcList}>
                  <li>
                    <span className={styles.t}>
                      OpenAI Codex Best Practices for 2026(getmaxim.ai)
                    </span>
                    <ExtLink href="https://www.getmaxim.ai/articles/openai-codex-best-practices-for-2026-workflows-governance-and-multi-provider-routing/">
                      getmaxim.ai/articles/...
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>
                      Proven Patterns for OpenAI Codex in 2026(DEV Community)
                    </span>
                    <ExtLink href="https://dev.to/kuldeep_paul/proven-patterns-for-openai-codex-in-2026-prompts-validation-and-gateway-governance-1jhm">
                      dev.to/kuldeep_paul/...
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>OpenAI Codex CLI Guide 2026(codegateway.dev)</span>
                    <ExtLink href="https://www.codegateway.dev/en/blog/openai-codex-cli-complete-guide-2026">
                      codegateway.dev/en/blog/...
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>OpenAI Codex Guide(kingy.ai)</span>
                    <ExtLink href="https://kingy.ai/news/the-complete-guide-to-openai-codex/">
                      kingy.ai/news/...
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>
                      Codex CLI approval_policy 解説(smartscope.blog)
                    </span>
                    <ExtLink href="https://smartscope.blog/en/generative-ai/chatgpt/codex-cli-approval-policy-implementation/">
                      smartscope.blog/en/.../codex-cli-approval-policy
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>
                    ...
                    <ExtLink href="https://vladimirsiedykh.com/blog/codex-cli-approval-modes-2025">
                      vladimirsiedykh.com/blog/...
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>Codex CLI config.toml Deep Dive(ofox.ai)</span>
                    <ExtLink href="https://ofox.ai/blog/codex-cli-config-toml-deep-dive/">
                      ofox.ai/blog/...
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>The Codex CLI Customisation Stack</span>
                    <ExtLink href="https://codex.danielvaughan.com/2026/04/12/codex-cli-customisation-stack-unified-system/">
                      codex.danielvaughan.com/.../customisation-stack
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>Codex CLI for CI/CD</span>
                    <ExtLink href="https://codex.danielvaughan.com/2026/03/26/codex-cli-cicd-non-interactive/">
                      codex.danielvaughan.com/.../cicd-non-interactive
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>Reasoning Effort Tuning</span>
                    <ExtLink href="https://codex.danielvaughan.com/2026/03/27/reasoning-effort-tuning/">
                      codex.danielvaughan.com/.../reasoning-effort-tuning
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>
                      Best Open Source CLI Coding Agents in 2026(Pinggy Blog)
                    </span>
                    <ExtLink href="https://pinggy.io/blog/best_open_source_cli_coding_agents/">
                      pinggy.io/blog/...
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>Agents.md best practices(GitHub Gist)</span>
                    <ExtLink href="https://gist.github.com/0xfauzi/7c8f65572930a21efa62623557d83f6e">
                      gist.github.com/0xfauzi/...
                    </ExtLink>
                  </li>
                  <li>
                    <span className={styles.t}>OpenAI Codex(AI agent) – Wikipedia</span>
                    <ExtLink href="https://en.wikipedia.org/wiki/OpenAI_Codex_(AI_agent)">
              ...
              <div className={styles.srcGroup}>
                ...
                <ul className={styles.srcList}>
                  <li>
                    ...
                    <ExtLink href="https://huggingface.co/blog/security-incident-july-2026">
