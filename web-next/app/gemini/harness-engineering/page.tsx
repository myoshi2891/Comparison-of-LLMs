    ...
    <>
      ...
      <header className={styles.hero}>
        ...
        <div className={styles.heroWrap}>
          <div className={styles.heroKicker}>Google Testing Blog / SWE Book 準拠 — 2026年版</div>
          <h1>
            <span className={styles.accentBlue}>HARNESS</span>
            <br />
            <span className={styles.accentGrn}>ENGI</span>
            <span className={styles.accentYel}>NEER</span>
            <span className={styles.accentRed}>ING</span>
          </h1>
          <p className={styles.heroDesc}>
            Googleが1日に数十億件のテストを回す規模で実践する
            <strong>テストハーネス設計の全技術</strong>
            を、初学者がゼロから現場レベルまで到達できるようにステップバイステップで解説します。
          </p>
          <div className={styles.heroChips}>
            <span className={`${styles.chip} ${styles.chipB}`}>Google Testing Blog</span>
            <span className={`${styles.chip} ${styles.chipG}`}>SWE Book</span>
            <span className={`${styles.chip} ${styles.chipY}`}>Google Test / gtest</span>
            <span className={`${styles.chip} ${styles.chipR}`}>Hermetic Tests</span>
            <span className={`${styles.chip} ${styles.chipP}`}>ADK Eval</span>
          </div>
        </div>
      </header>
...
S4 --> S5`}
          ...
          <div className={styles.codeWrap}>
            ...
            <pre className={styles.codeBody}>
              <span className={styles.ck}>def</span>{" "}
              <span className={styles.cv}>test_register_user_saves_to_repository</span>
              (user_service, fake_repo):
              {"\n"}
              {"    "}
              <span className={styles.cc}>
          ...
          <div className={styles.codeWrap}>
            ...
            <pre className={styles.codeBody}>
              ...
              {"\n"}
              {"    "}
              std::unique_ptr&lt;<span className={styles.cv}>MockEmailService</span>&gt;
              mock_email_;
              {"\n"}
              {"    "}
          ...
          <div className={styles.cmp}>
            <div className={styles.cmpNg}>
              ...
              <div className={styles.codeWrap} style={{ margin: 0 }}>
                <pre className={styles.codeBody}>
                  <span className={styles.ck}>def</span>{" "}
                  <span className={styles.cv}>_make_user</span>
        ...
        <section id="s11" className={styles.sec}>
          ...
          <div className={styles.srcGrid}>
            ...
            <div className={styles.srcCard}>
              ...
              <Ext href="https://github.com/google/googletest">
                Google Test (googletest) — GitHub
              </Ext>
              <div className={styles.srcDesc}>
