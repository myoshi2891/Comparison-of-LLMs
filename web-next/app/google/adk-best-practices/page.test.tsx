...
import PageComponent, { metadata as rawMetadata } from "@/app/google/adk-best-practices/page";
...
describe("/google/adk-best-practices - metadata", () => {
  it("exports a metadata object with title containing 'Google Agent Development Kit 実践ガイド'", () => {
...
describe("/google/adk-best-practices - page structure", () => {
  it("renders an <h1> containing 'Google Agent Development Kit 実践ガイド'", () => {
    const { container } = render(<Page />);
    const h1 = container.querySelector("h1");
    expect(h1).not.toBeNull();
    expect(h1?.textContent).toContain("Google Agent Development Kit 実践ガイド");
  });

  it("renders all 15 expected sections", () => {
    const { container } = render(<Page />);
    const sections = container.querySelectorAll("section.adkSection");
...
describe("/google/adk-best-practices - external link safety", () => {
...
describe("/google/adk-best-practices - code block validation", () => {
...
describe("/google/adk-best-practices - static source safety", () => {
