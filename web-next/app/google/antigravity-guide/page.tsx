        ...
        <main className={styles.main}>
          <div className={styles.hero}>
            ...
            <div className={styles.term}>
              ...
              <div className={styles.termBody}>
                ...
                <p className={styles.termLine}>
                  <span className={styles.termPrompt}>❯</span> <span className={styles.caret} />
                </p>
              </div>
            </div>
          ...
          <div className="content-wrap">
            ...
            <section id="overview" className={styles.section}>
              ...
              <p>
                Antigravity CLI (<code>agy</code>) は、Google が 2026 年 5 月に発表した Terminal UI
                (TUI) 型のエージェント型コーディングツールです。旧 Gemini CLI の後継にあたり、Go
                言語で実装されています。最大の特徴は、Antigravity 2.0 (デスクトップ GUI) ・
                Antigravity IDE (VS Code フォーク) ・ Antigravity SDK (Python) と
              ...
              <p>
                同じハーネスを使っているため、
                <strong>推論エンジンの改善は CLI と GUI 双方に自動反映</strong>
                され、パーミッション設定なども共有されます
                (会話履歴自体は既定では共有されません)。本ガイドでは、インストールから日常運用、自動化、トラブルシューティングまでを実務で使う順に沿って解説します。
              </p>
            </section>
            ...
            <section id="install" className={styles.section}>
              ...
              <p>
                既定のインストール先: macOS/Linux は <code>~/.local/bin/agy</code>、Windows は{" "}
                <code>C:\Users\&lt;Username&gt;\AppData\Local\agy\bin</code>。
              </p>
              ...
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <code>--skip-aliases</code>
                      </td>
                      <td>
                        旧 <code>agy</code>/<code>antigravity</code>{" "}
                        シェルエイリアスの整理をスキップ
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        シェルプロファイルへの <code>PATH</code> 追記をスキップ
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className={`${styles.callout} ${styles.calloutInfo}`}>
                ...
                <p>
                  <code>agy: command not found</code> になる場合は <code>~/.bashrc</code> または{" "}
                  <code>~/.zshrc</code> に <code>export PATH="~/.local/bin:$PATH"</code> を追記し{" "}
                  <code>source</code> し直してください。
                </p>
              </div>
              ...
              <p>
                CLI は macOS の Keychain、Linux の Secret Service (D-Bus)、Windows Credential
                Manager など OS
                標準のセキュアストレージにトークンを保存します。エンタープライズ利用時はオンボーディング時に
                GCP プロジェクトを接続してください。ログアウトは以下で行います。
              </p>
            ...
            <section id="start" className={styles.section}>
              ...
              <p>
                初回起動時にカラースキーム・レンダリングモード (Alt-Screen / Inline)
                ・ワークスペースの信頼設定などをウィザード形式で聞かれます。
              </p>
              ...
              <div className={styles.callout}>
                ...
                <p>
                  プロジェクトを 1
                  つの親フォルダにまとめておくと、そのフォルダ配下であれば毎回パーミッション確認なしにエージェントがアクセスできるようになり、複数プロジェクトを横断する指示
                  (「Aのこの機能をBにも適用して」等) がスムーズになります。
                </p>
              </div>
            ...
            <section id="modes" className={styles.section}>
              ...
              <p>
                Antigravity CLI には 3 つの実行モードがあり、
                <strong>エージェントの自律性と開発者のレビュー負荷のトレードオフ</strong>
                を調整します。
              </p>
                ...
                <table className={styles.table}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        プロンプトに <code>/plan</code> を自動付与し、変更前に調査・計画を提示
                      </td>
              ...
              <div className={`${styles.callout} ${styles.calloutWarn}`}>
                ...
                <p>
                  <code>command(git)</code>{" "}
                  のようなシェルコマンド実行の可否は、実行モードに関係なく常に{" "}
                  <code>/permissions</code> の設定 (または{" "}
                  <code>--dangerously-skip-permissions</code>)
                  が優先されます。実行モードはあくまで「ファイル書き込み」の自動承認に関わる設定です。
                </p>
              </div>
              ...
              <p>
                セッション中に切り替える場合は <code>Shift+Tab</code>{" "}
                を押すだけで循環します。恒久的な既定値は <code>/config</code> (
                <code>/settings</code>) から変更するか、<code>settings.json</code>{" "}
                に以下を書きます。
              </p>
              ...
              <div className={`${styles.callout} ${styles.calloutWarn}`}>
                ...
                <p>
                  ...
                  <strong>
                    旧来の <code>/planning</code> と <code>/fast</code> スラッシュコマンドは v1.1.0
                    で廃止 (vestigial)
                  </strong>{" "}
                  となり、現在は <code>Shift+Tab</code> によるモード循環、または <code>/plan</code>{" "}
                  をプロンプト先頭に付ける方式に統一されています。一方で同時期に取得した CLI
                  リファレンス表にはまだ <code>/fast</code>・<code>/planning</code>{" "}
                  の記載が残っており、ドキュメント間で不整合が見られました。実運用では{" "}
                  <code>/help</code> または <code>agy --help</code>{" "}
                  で手元のバージョンの正式な挙動を必ず確認してください。
                </p>
              </div>

              <h3>
                <code>default</code> モードでの差分レビュー操作
              </h3>
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        フルスクリーンのスクロール可能な差分ビュー (前後 3 行のコンテキスト付き)
                        を開く
                      </td>
                    </tr>
                    <tr>
            ...
            <section id="commands" className={styles.section}>
              ...
              <p>
                <code>/</code>{" "}
                を入力するとタイプアヘッド候補メニューが開きます。以下は公式リファレンスに掲載されている全
                32 個の中核コマンド一覧です。
              </p>
              ...
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <code>/effort [level]</code>
                      </td>
                      <td>設定</td>
                      <td>—</td>
                      <td>
                        推論モデルの思考努力レベル (low / medium / high 等) を設定。起動時の{" "}
                        <code>--effort</code> と相互同期
                      </td>
                    </tr>
                    <tr>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>会話</td>
                      <td>
                        <code>/switch</code>, <code>/conversation</code>
                      </td>
              ...
              <p>
                Google Codelabs
                のハンズオン教材では、上表には無い以下のプロンプト接頭辞・コマンドが紹介されています。挙動が確認できるまでは{" "}
                <code>/help</code> での併用確認を推奨します。
              </p>
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        指定したゴールが完全に達成されるまでエージェントが自律的に反復実行し続ける
                        (テスト全通過まで自己修復するようなタスクに有効)
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        UI やアーキテクチャのリファクタリングなど複雑な変更の前に、まず実装計画
                        (Implementation Plan) を提示させる
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <code>/grill-me &lt;指示&gt;</code>
                      </td>
                      <td>
                        実装前にインタビュー形式で要件・デザインの選択肢を 1
                        問ずつ確認してくれる、詳細な壁打ちプランニング
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        Bash モード。<code>!</code>{" "}
                        を先頭に付けるとエージェントを介さず直接シェルコマンドを実行 (例:{" "}
            ...
            <section id="details" className={styles.section}>
              ...
              <h3 id="d-permissions">
                <code>/permissions</code> — パーミッション管理
              </h3>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                  <span>コマンド</span>
              ...
              <ol>
                <li>
                  <strong>スコープピッカー</strong>: <code>Project</code> (現在のプロジェクトのみ) /{" "}
                  <code>Shared</code> (全 Antigravity 製品共通) / <code>Global</code>{" "}
                  (全セッション共通) から選択 (<code>↑/↓</code>, <code>Enter</code>)。
                </li>
                <li>
                  <strong>ルールビューア</strong>: <code>←/→</code> (または <code>Tab</code>) で{" "}
                  <code>allowlist</code> / <code>denylist</code> / <code>asklist</code> タブを切替。
                  <code>a</code> で追加、<code>e</code> (または <code>Ctrl+G</code>) で編集、
                  <code>d</code> (または <code>Backspace</code>) で削除。
                </li>
                <li>
                  <strong>ルール追加/編集</strong>: <code>action(target)</code> 形式で入力 (例:{" "}
                  <code>command(git)</code>, <code>read_file(/path/to/dir)</code>)。
                  <code>Enter</code> で保存。
                </li>
              </ol>
              <div className={`${styles.callout} ${styles.calloutInfo}`}>
                <div className={styles.calloutTitle}>TIP</div>
                <p>
                  ワークスペース外のファイルにエージェントがアクセスするたびに確認を求められるのが煩わしい場合、
                  <code>settings.json</code> に直接 <code>permissions.allow</code>{" "}
                  を追記すると快適です。パスマッチングは再帰的なので、ディレクトリを 1
                  つ許可すれば配下すべてに適用されます。<code>write_file</code> は{" "}
                  <code>read_file</code> を包含します。
                </p>
              </div>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                ...
                <table className={styles.table}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <code>↑/↓</code> 移動、<code>Enter</code> 詳細表示、<code>Esc</code> 終了
                      </td>
                    </tr>
                    <tr>
                      <td>詳細ビュー</td>
                      <td>
                        <code>↑/↓</code> スクロール、<code>j/k</code> または <code>←/→</code>{" "}
                        でファイル切替、<code>n/N</code> でハンク間ジャンプ、<code>c</code>{" "}
                        でコメント追加、<code>d</code> でコメント削除
                      </td>
                    </tr>
                    <tr>
                      <td>コミットツリー</td>
                      <td>
                        <code>↑/↓</code> コミット移動、<code>←/→</code> ブランチ移動、
                        <code>Enter</code> で差分表示
                      </td>
                    </tr>
                    <tr>
                      <td>終了確認画面</td>
                      <td>
                        <code>Shift+Y</code> コメント送信して終了、<code>Shift+N</code> 破棄して終了
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <p>
                <strong>ステップバイステップ: 行コメントでエージェントを誘導する</strong>
              </p>
              <ol>
                <li>詳細ビューでコメントしたい行にカーソルを合わせる。</li>
                <li>
                  <code>c</code> を押してコメント入力欄を開く。
                </li>
                <li>
                  フィードバックを入力し <code>Enter</code> で保存 (💬アイコンがガター表示)。
                </li>
                <li>
                  <code>Esc</code> でファイル一覧に戻り、さらに <code>Esc</code> で終了。
                </li>
                <li>
                  未送信コメントの確認画面で <code>Shift+Y</code> を押すと、
                  <code>&lt;file&gt;:&lt;line&gt;: &lt;comment&gt;</code>{" "}
                  形式で整形されエージェントへの次の指示として送られます。
                </li>
              </ol>

              <h3 id="d-resume">
                <code>/resume</code> — 会話の再開
              </h3>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                  <span>コマンド</span>
                ...
                <table className={styles.table}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>削除</td>
                      <td>
                        <code>Ctrl+Delete</code> → <code>Enter</code>/<code>y</code> で確定
                      </td>
                    </tr>
                    <tr>
                      <td>Antigravity 2.0からインポート</td>
                      <td>
                        <code>Tab</code> でタブ切替 → <code>Enter</code> → <code>y</code>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <p>
                再開キャッシュは{" "}
                <code>~/.gemini/antigravity-cli/cache/last_conversations.json</code>{" "}
                に、ワークスペースの絶対パスと会話 ID のマップとして保存されています。
              </p>

              <h3 id="d-codesearch">
                <code>/codesearch</code> (エイリアス: <code>/cs</code>, <code>/search</code>) —
                コード検索
              </h3>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
              ...
              <p>
                結果を <code>Enter</code> で開いてファイルビューアでコードを閲覧し、<code>c</code>{" "}
                で行コメント、<code>Esc</code> で終了時に送信確認 (<code>y</code>/<code>n</code>)
                が出る点は <code>/diff</code> と同様の設計です。
              </p>
              ...
              <p>
                <strong>カスタムエージェントの作成 (グローバル)</strong>
              </p>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                ...
                <div className={styles.codeBody}>
                  ...
                  <div className={styles.codeLine}>
                    description:
                    エッジケースとセキュリティに重点を置くコードレビュー専門エージェント
                  </div>
                  <div className={styles.codeLine}>---</div>
                  <div className={styles.codeLine}>
              ...
              <p>
                プロジェクト単位で限定したい場合は{" "}
                <code>&#123;workspace&#125;/.agents/agents/&lt;agent_name&gt;/agent.md</code>{" "}
                に配置します。
              </p>
              ...
              <div className={`${styles.callout} ${styles.calloutWarn}`}>
                ...
                <p>
                  アクティブな会話中にエージェントを切り替えると、履歴の整合性を保つために
                  <strong>自動的に会話がフォーク</strong>
                  されます。新規セッションからの切替は直接反映されます。
                </p>
              </div>

              <h3 id="d-statusline">
                <code>/statusline</code> — ステータスバーのカスタマイズ
              </h3>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                  <span>コマンド例</span>
              ...
              <p>
                <strong>実務例</strong> (著名な Google Cloud Developer Advocate
                の公開スクリプトより): モデル名・カレントディレクトリ・git
                ブランチ・未コミット数・同期状況・トークン使用率をカラー表示するステータスラインの例。
              </p>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                ...
                <div className={styles.codeBody}>
                  ...
                  <div className={styles.codeLine}>
                    ...
                    <span className={styles.cv}>
                      {" "}
                      "5c5593e50a09262a80ccfae53b0167467bc7e563556a8a92543c32f796ab5e9c
                      ~/.gemini/antigravity-cli/statusline.sh" | sha256sum -c -
                    </span>
                  </div>
                  <div className={styles.codeLine}>
              ...
              <h3 id="d-usage">
                <code>/usage</code> (エイリアス <code>/quota</code>) ・ <code>/credits</code> —
                使用量管理
              </h3>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                ...
                <div className={styles.codeBody}>
                  <div className={styles.codeLine}>
                    ...
                    <span className={styles.cc}>
                      {" "}
                      # モデルごとのクォータ (残リクエスト/トークン数) を表示・自動リフレッシュ
                    </span>
                  </div>
                  <div className={styles.codeLine}>
                    ...
                    <span className={styles.cc}>
                      {" "}
                      # AI Premium クレジットの残高・消費履歴・購入リンクを表示
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <code>Shift+Enter</code> / <code>Ctrl+J</code>
                      </td>
                      <td>改行 (送信しない)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <code>$EDITOR</code> を起動してプロンプトを作成
                      </td>
                    </tr>
                    <tr>
                      <td>
                    ...
                    <tr>
                      <td>
                        <code>Ctrl+Z</code> / <code>Ctrl+Shift+Z</code>
                      </td>
                      <td>元に戻す / やり直す</td>
                    </tr>
                  </tbody>
              ...
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <code>PgUp</code> / <code>Shift+↑</code>
                      </td>
                      <td>1 ページ分上スクロール</td>
                    </tr>
                    <tr>
                      <td>
                        <code>PgDn</code> / <code>Shift+↓</code>
                      </td>
                      <td>1 ページ分下スクロール</td>
                    </tr>
                    <tr>
            ...
            <section id="settings" className={styles.section}>
              ...
              <p>
                保存場所: <code>~/.gemini/antigravity-cli/settings.json</code> (TUI 内では{" "}
                <code>/config</code> または <code>/settings</code> で編集可能)
              </p>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                ...
                <table className={styles.table}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <code>light</code> / <code>solarized light</code> /{" "}
                        <code>colorblind-friendly light</code> / <code>dark</code> /{" "}
                        <code>solarized dark</code> / <code>colorblind-friendly dark</code> /{" "}
                        <code>tokyo night</code> / <code>terminal</code>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <code>altScreenMode</code>
                      </td>
                      <td>string</td>
                      <td>
                        <code>default</code>
                      ...
                      <td>
                        <code>default</code> (適応的) / <code>always</code>{" "}
                        (常にオルタネートスクリーン) / <code>never</code> (常にインライン)
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>string</td>
                      <td>
                        <code>request-review</code>
                      </td>
                      <td>
                        <code>request-review</code> / <code>proceed-in-sandbox</code> /{" "}
                        <code>always-proceed</code> / <code>strict</code>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <code>artifactReviewPolicy</code>
                      </td>
                      <td>string</td>
                      <td>
                        <code>asks-for-review</code>
                      </td>
                      <td>
                        <code>asks-for-review</code> / <code>agent-decides</code> /{" "}
                        <code>always-proceed</code>
                      </td>
                    </tr>
                    <tr>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <code>auto</code> (<code>$EDITOR</code> 参照) / <code>vim</code> /{" "}
                        <code>emacs</code> / カスタム文字列
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <code>allowNonWorkspaceAccess</code>
                      </td>
                      <td>boolean</td>
                      <td>
                        <code>false</code>
                    ...
                    <tr>
                      <td>
                        <code>enableTerminalSandbox</code>
                      </td>
                      <td>boolean</td>
                      <td>
                        <code>false</code>
                    ...
                    <tr>
                      ...
                      <td>
                        <code>high</code> (全表示) / <code>low</code> (最小限のインジケータのみ)
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <code>runningLightSpeed</code>
                      </td>
                      <td>string</td>
                      <td>
                        <code>medium</code>
                      ...
                      <td>
                        進捗アニメーション速度: <code>fast</code>/<code>medium</code>/
                        <code>slow</code>/<code>off</code>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        起動時の既定実行モード: <code>default</code>/<code>accept-edits</code>/
                        <code>plan</code>
                      </td>
                    </tr>
                  </tbody>
              ...
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <code>~/.gemini/antigravity-cli/keybindings.json</code>
                      </td>
                      <td>
                        カスタムキーバインド (<code>/keybindings</code> からも編集可)
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <code>agy -c</code> 用のワークスペース別・直近会話キャッシュ
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <code>~/.gemini/antigravity-cli/updater/update.lock</code>
                      </td>
                      <td>セルフアップデーターのアドバイザリロック</td>
                    </tr>
                    <tr>
                      <td>
                        <code>~/.gemini/config/agents/&lt;name&gt;/agent.md</code>
                      </td>
                      <td>グローバルなカスタムエージェント定義</td>
                    </tr>
                    <tr>
                      <td>
                        <code>&#123;workspace&#125;/.agents/agents/&lt;name&gt;/agent.md</code>
                      </td>
              ...
              <p>
                <code>--effort</code>、<code>--sandbox</code>、
                <code>--dangerously-skip-permissions</code> のように、起動時フラグはセッション設定や{" "}
                <code>settings.json</code> の値を一時的に上書きできます。<code>--effort</code> は{" "}
                <code>/effort [level]</code>{" "}
                と相互同期します。設定パネルには上書き元が表示され、永続設定自体は変更されません
                (再起動でフラグの効果は消えます)。
              </p>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
              ...
              <div className={`${styles.callout} ${styles.calloutWarn}`}>
                ...
                <p>
                  <code>--dangerously-skip-permissions</code>{" "}
                  は全てのツール承認要求を無条件で自動承認します。信頼できない入力やネットワークアクセス可能な本番環境に近い場所では使用しないでください。
                </p>
              </div>
            </section>
            ...
            <section id="permissions" className={styles.section}>
              ...
              <p>
                Antigravity CLI は「どこまでエージェントに自律性を与えるか」を、
                <strong>Tool Permission (何を許可するか)</strong> と{" "}
                <strong>Sandbox (どこで実行するか)</strong> の 2 軸で制御します。
              </p>
              ...
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <code>request-review</code> (既定)
                      </td>
                      <td>書込み・bash コマンド・リモートネットワーク呼び出しの前に必ず確認</td>
                    </tr>
                    <tr>
                      <td>
                        <code>proceed-in-sandbox</code>
                      </td>
                      <td>
                        実行をサンドボックスに封じ込め、安全なコマンドは自動実行・危険なコマンドのみ確認
                      </td>
                    </tr>
                    <tr>
                      <td>
              ...
              <p>
                サンドボックスが有効な場合、確認プロンプトには「サンドボックスなしで今回だけ実行」というオプションが、無効な場合は「今回だけサンドボックス内で実行」というオプションが追加表示されます
                (単発の例外対応)。
              </p>
              ...
              <div className={styles.codeWrap}>
                ...
                <div className={styles.codeBody}>
                  <div className={styles.codeLine}>
                    command(git) <span className={styles.cc}># git コマンド全体を許可</span>
                  </div>
                  <div className={styles.codeLine}>
                    command(git diff){" "}
                    <span className={styles.cc}># git diff のみ許可 (より限定的)</span>
                  </div>
                  <div className={styles.codeLine}>
                    read_file(/path/to/dir){" "}
                    <span className={styles.cc}>
                      # 指定ディレクトリ配下の読み取りを許可 (再帰的)
                    </span>
                  </div>
                  <div className={styles.codeLine}>
                    write_file(/path/to/file){" "}
                    <span className={styles.cc}>
                      # 指定ファイル/ディレクトリへの書込みを許可 (read_fileを包含)
                    </span>
                  </div>
                </div>
              </div>
            ...
            <section id="mcp" className={styles.section}>
              ...
              <p>
                Antigravity CLI は MCP を通じて Jira・Confluence・GitHub・Playwright・Snyk
                などの外部ツールと連携できます。
              </p>
              ...
              <p>
                <strong>設定ファイルの場所</strong> (Google Codelabs のハンズオン教材による記載):
              </p>
              <ul>
                <li>
                  グローバル設定: <code>~/.gemini/config/mcp_config.json</code>
                </li>
                <li>
                  ワークスペースローカル設定: <code>.agents/mcp_config.json</code>{" "}
                  (プロジェクト直下)
                </li>
              </ul>
              ...
              <div className={`${styles.callout} ${styles.calloutInfo}`}>
                ...
                <p>
                  共有 (Shared) スコープの MCP 設定は <code>~/.gemini/config/</code> 配下、CLI
                  固有の設定は <code>~/.gemini/antigravity-cli/</code>{" "}
                  配下に保存されます。手元の環境では <code>/mcp</code> コマンドの表示、または{" "}
                  <code>agy --help</code> でも実際のパスを確認してください。
                </p>
              </div>
              ...
              <div className={styles.codeWrap}>
                ...
                <div className={styles.codeBody}>
                  ...
                  <div className={styles.codeLine}>
                    ...
                    <span className={styles.cs}>"snyk@1.1306.2"</span>,{" "}
                    <span className={styles.cs}>"mcp"</span>,{" "}
                    <span className={styles.cs}>"-t"</span>,{" "}
                    <span className={styles.cs}>"stdio"</span>,{" "}
                    <span className={styles.cs}>"--experimental"</span>],
                  </div>
                  <div className={styles.codeLine}>
                    {"      "}
                  ...
                  <div className={styles.codeLine}>
                    ...
                    <span className={styles.ck}>"args"</span>: [
                    <span className={styles.cs}>"-y"</span>,{" "}
                    <span className={styles.cs}>"mcp-remote@0.1.38"</span>,{" "}
                    <span className={styles.cs}>"https://mcp.atlassian.com/v1/sse"</span>]
                  </div>
                  <div className={styles.codeLine}>{"    "}&#125;,</div>
                  <div className={styles.codeLine}>
                    {"    "}
                  ...
                  <div className={styles.codeLine}>
                    ...
                    <span className={styles.ck}>"args"</span>: [
                    <span className={styles.cs}>"-y"</span>,{" "}
                    <span className={styles.cs}>"@playwright/mcp@0.0.78"</span>]
                  </div>
                  <div className={styles.codeLine}>{"    "}&#125;,</div>
                  <div className={styles.codeLine}>
                    {"    "}
                  ...
                  <div className={styles.codeLine}>
                    {"      "}
                    <span className={styles.ck}>"env"</span>: &#123;{" "}
                    <span className={styles.ck}>"GITHUB_PERSONAL_ACCESS_TOKEN"</span>:{" "}
              ...
              <ul>
                <li>
                  <strong>Snyk</strong>:
                  ワークスペースを離れずに依存関係の脆弱性スキャンをエージェントに実行させる
                </li>
                <li>
                  <strong>Atlassian</strong>: Jira/Confluence
                  のチケット作成・検索・更新を自然言語で指示
                </li>
                <li>
                  <strong>Playwright</strong>: ブラウザ自動操作 (<code>browser_navigate</code>、
                  <code>browser_click</code>、<code>browser_take_screenshot</code> 等) による E2E
                  テストや画面確認
                </li>
                <li>
            ...
            <section id="extend" className={styles.section}>
              <h2>
                ...
                カスタムエージェント・Skills・Plugins・Hooks
              </h2>

              <h3>Agent Skills</h3>
              <p>
                Skills は、特定タスクの手順・スクリプト・参照リソースを記述した宣言的な Markdown
                ファイルです。登録されると自動的にスラッシュコマンド化されます (例:{" "}
                <code>/refactor-ui</code>)。
              </p>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
                  <span>コマンド</span>
              ...
              <h3>Plugins</h3>
              <p>
                Plugins は Skills・バックグラウンドサブエージェント・Lint ルール・MCP
                定義・イベントフックを 1
                つのパッケージにまとめた名前空間付きバンドルです。カスタムエージェントも Plugin
                経由で配布できます。
              </p>

              <h3>Hooks</h3>
              <p>
                ツール実行の直前/直後に処理を挟み込む仕組みで、pre-flight チェックや post-format
                フォーマッタ (例: ファイル書込み後の <code>prettier</code> 自動実行)
                に使われます。Plugin 内の <code>hooks.json</code>、または <code>settings.json</code>{" "}
                本体に定義します。
              </p>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
              ...
              <h3>
                プロジェクトルールファイル (<code>AGENTS.md</code> / <code>GEMINI.md</code>)
              </h3>
              <p>
                プロジェクトルートに <code>AGENTS.md</code> (または <code>GEMINI.md</code>)
                を配置すると、コーディング規約・スタイル指針・テストコマンド・非推奨事項などをエージェントが起動時に自動的に読み込み、変更提案の前に参照します。
              </p>
              <div className={`${styles.callout} ${styles.calloutInfo}`}>
                <div className={styles.calloutTitle}>TIP</div>
                <p>
                  Claude Code
                  など他ツールも併用している場合、シンボリックリンクで指示ファイルを共有すると二重管理を避けられます。
                </p>
              </div>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
              ...
              <p>
                <code>AGENTS.md</code> には TODO
                リストを書いておくのもおすすめです。「TODOリストの状況を教えて」と聞くだけで、エージェントが正確に現在地を把握して回答してくれます。
              </p>
              <div className={styles.codeWrap}>
                <div className={styles.codeBar}>
              ...
              <p>
                グローバル版のルールファイルは <code>~/.gemini/AGENTS.md</code>{" "}
                に置くことで全プロジェクト共通の指示にできます。
              </p>
            </section>
            ...
            <section id="automation" className={styles.section}>
              ...
              <div className={styles.codeWrap}>
                ...
                <div className={styles.codeBody}>
                  <div className={styles.codeLine}>
                    ...
                    <span className={styles.cv}>
                      {" "}
                      -p "このgit diffをレビューしてConventional
                      Commits形式のコミットメッセージを提案して" --cwd $(pwd)
                    </span>
                  </div>
                </div>
              </div>
              ...
              <h3>
                Bash モード (<code>!</code> プレフィックス)
              </h3>
              <p>
                対話中に単純なコマンドをすぐ実行したい場合、<code>!</code>{" "}
              ...
              <h3>バックグラウンドタスク</h3>
              <p>
                長時間かかるタスクは <code>Ctrl+B</code> でバックグラウンドに送れます。進行状況は{" "}
                <code>/tasks</code> (シェル実行系) または <code>/agents</code> (サブエージェント系)
                で監視できます。
              </p>
              ...
              <p>
                <code>AGY_CLI_DISABLE_AUTO_UPDATE=true</code> を環境変数に設定しておくと、CI
                環境でセルフアップデーターが介入するのを防げます。
              </p>
            </section>
            ...
            <section id="practices" className={styles.section}>
              <h2>
                <span className={styles.idx}>12 /</span> ベストプラクティス (公式ガイド +
                実務Tips統合版)
              </h2>

              <h3>12-1. 検証ループを必ず組み込む</h3>
              <p>
                自律型エージェントから信頼できる変更を得る最も効果的な方法は、
                <strong>
                  ローカルに検証手段 (ユニットテスト・ビルドコマンド・フォーマッタ) を用意しておく
                </strong>
                ことです。
              </p>
              ...
              <div className={styles.codeWrap}>
                ...
                <div className={styles.codeBody}>
                  <div className={styles.codeLine}>
                    Explore how our router resolves `/docs/:page`. Write down an implementation plan
                    to add `/docs/best-practices`.
                  </div>
                </div>
              </div>
              <ul>
                ...
                <li>
                  <strong>計画</strong>: Implementation Plan artifact
                  (対象ファイル・依存関係・ロジック変更点を列挙) を要求
                </li>
                <li>
              ...
              <p>
                複雑な UI やアーキテクチャ変更では <code>/plan</code> コマンドや、要件を 1
                問ずつ確認してくれる <code>/grill-me</code> の活用も有効です。
              </p>
                ...
                <table className={styles.table}>
                  ...
                  <tbody>
                    <tr>
                      <td>ファイルパス補完</td>
                      <td>
                        プロンプト内で <code>@</code> を入力すると Interactive Path Suggestion
                        が開き、絶対パスを挿入できる
                      </td>
                    </tr>
                    <tr>
                      <td>スクリーンショット添付</td>
                      <td>
                        UI 崩れ等のビジュアルバグはスクリーンショット/動画をコピーし{" "}
                        <code>Ctrl+V</code> で貼り付け
                      </td>
                    </tr>
                    <tr>
                      <td>Webページ/ターミナル出力の貼り付け</td>
                      <td>
                        <code>Cmd+A</code>/<code>Ctrl+A</code> で全選択しコピーしてそのまま貼り付け
                      </td>
                    </tr>
                    <tr>
                      <td>絶対パスの取得</td>
                      <td>
                        <code>realpath some/relative/path</code> で絶対パスを取得しプロンプトに貼る
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <p>
                <code>AGENTS.md</code>/<code>GEMINI.md</code>{" "}
                にディレクトリ規約・スタイル・テストコマンド・非推奨事項を明記し、リスクレベルに応じて{" "}
                <code>toolPermission</code> を調整します (§08 参照)。
              </p>
                ...
                <table className={styles.table}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <code>Esc</code> で即座に中断しクリーンなプロンプトに戻る
                      </td>
                    </tr>
                    <tr>
                      <td>複数回の変更でビルドエラーが蓄積した</td>
                      <td>
                        <code>/rewind</code> (<code>/undo</code>)
                        で会話を安定していた時点まで巻き戻す
                      </td>
                    </tr>
                    <tr>
                      <td>実装方針に確信が持てない</td>
                      <td>
                        <code>/fork</code> で並行セッションを作り試行錯誤。失敗したら{" "}
                        <code>/resume</code> で本線に戻る
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <p>
                大規模な一括置換や複数ファイルにまたがるリファクタリングでは、メインエージェントにバックグラウンドのサブエージェントを生成させ、
                <code>/agents</code> パネルで監視しながら自分は別作業を継続できます。
              </p>

              <h3>12-7. ソフトウェア開発ライフサイクル全体でエージェントを使う</h3>
              <p>
                コード生成だけに偏重せず、Issue 理解・設計検討・PR レビュー・テスト作成など、SDLC
                全体でエージェントを活用することが推奨されています (著名な Google Cloud Developer
                Advocate による実務記事より)。
              </p>

              <h3>12-8. 音声入力の活用 (上級者向け実務 Tips)</h3>
              <p>
                タイピングより音声の方が指示速度が速いという Tips
                も共有されています。ローカルの音声認識モデルを使えば、多少の誤認識があっても LLM
                が文脈から意図を汲み取ってくれるため実用上問題ないケースが多いとされています。
              </p>
            </section>
              ...
              <div className={styles.tableWrap}>
                <table className={styles.table}>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <code>agy: command not found</code>
                      </td>
                      <td>
                        インストール先が <code>$PATH</code> に含まれていない
                      </td>
                      <td>
                        <code>~/.bashrc</code>/<code>~/.zshrc</code> に{" "}
                        <code>export PATH="~/.local/bin:$PATH"</code> を追記し <code>source</code>
                        。Windows は <code>SetEnvironmentVariable</code> で PATH を追記
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <code>keyring: secure lock out</code>
                      </td>
                      <td>OS キーリングサービスの権限不足・ロック</td>
                      <td>
                        macOS: Keychain Access で <code>agy</code> のアクセス許可を確認、SSH
                        経由なら <code>security unlock-keychain</code> 実行。Linux:{" "}
                        <code>export $(dbus-launch)</code> で D-Bus セッションを起動
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        iTerm2/Ghostty を使用し「Applications in terminal may access
                        clipboard」を有効化 (OSC 52)。tmux 利用時は{" "}
                        <code>set -s set-clipboard on</code>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <code>rm -f ~/.gemini/antigravity-cli/updater/update.lock</code>{" "}
                        でロック解除。<code>export AGY_CLI_DISABLE_AUTO_UPDATE=true</code>{" "}
                        で自動更新を停止可能
                      </td>
                    </tr>
                  </tbody>
            ...
            <section id="security" className={styles.section}>
              ...
              <p>
                Antigravity CLI の公式 GitHub リポジトリでは、AI
                コーディングエージェント全般に共通するリスクとして以下が明記されています。
              </p>
              <ul>
              ...
              <ol>
                <li>
                  <strong>
                    既定 (<code>request-review</code>/<code>strict</code>) で運用
                  </strong>
                  し、信頼度に応じて <code>proceed-in-sandbox</code> → <code>always-proceed</code>{" "}
                  へ緩めていく。
                </li>
                <li>
                  <strong>
                    サンドボックス (<code>enableTerminalSandbox: true</code>) を有効化
                  </strong>
                  し、ローカル実行コマンドを OS コンテインメントリングに封じ込める。
                </li>
                <li>
                  <strong>
                    <code>--dangerously-skip-permissions</code> はコンテナ・使い捨て VM
                    など隔離環境限定
                  </strong>
                  で使用する。
                </li>
                <li>
                  外部ネットワーク接続を伴う MCP サーバー (GitHub トークン等) は
                  <strong>最小権限のトークン</strong>を発行する。
                </li>
                <li>
                  Antigravity (旧 Gemini CLI を含む)
                  はサービス提供状況が急遽変更されることがあった実績があるため (著名な AI 評論家
                  Simon Willison 氏のブログ・X 投稿でも複数回報告)、本番 CI/CD
                  に組み込む場合は可用性リスクも考慮してください。
                </li>
              </ol>
            </section>
            ...
            <section id="references" className={styles.section}>
              ...
              <p>
                本ガイドは以下の一次情報源 (公式ドキュメント・公式リポジトリ・Google 公認 Developer
                Advocate による技術記事・国際的に著名な AI/開発者評論家の投稿)
                を根拠にしています。確認日は 2026 年 7 月 29 日です。
              </p>
              ...
              <div>
                ...
                <ul>
                  <li>
                    CLI 概要:{" "}
                    <Ext href="https://antigravity.google/docs/cli/overview">
                      https://antigravity.google/docs/cli/overview
                    </Ext>
                  </li>
                  <li>
                    インストール・認証:{" "}
                    <Ext href="https://antigravity.google/docs/cli/install">
                      https://antigravity.google/docs/cli/install
                    </Ext>
                  </li>
                  <li>
                    実行モード:{" "}
                    <Ext href="https://antigravity.google/docs/cli/modes">
                      https://antigravity.google/docs/cli/modes
                    </Ext>
                  </li>
                  <li>
                    CLI リファレンス (全コマンド・キーバインド・設定キー):{" "}
                    <Ext href="https://antigravity.google/docs/cli/reference">
                      https://antigravity.google/docs/cli/reference
                    </Ext>
                  </li>
                  <li>
                    ベストプラクティス:{" "}
                    <Ext href="https://antigravity.google/docs/cli/best-practices">
                      https://antigravity.google/docs/cli/best-practices
                    </Ext>
                  </li>
                  <li>
                    トラブルシューティング:{" "}
                    <Ext href="https://antigravity.google/docs/cli/troubleshooting">
                      https://antigravity.google/docs/cli/troubleshooting
                    </Ext>
                  </li>
                  <li>
                    機能概要 (サンドボックス・サブエージェントパネル):{" "}
                    <Ext href="https://antigravity.google/docs/cli/features">
                      https://antigravity.google/docs/cli/features
                    </Ext>
                  </li>
                  <li>
                    /agents コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/agents">
                      https://antigravity.google/docs/cli/commands/agents
                    </Ext>
                  </li>
                  <li>
                    /codesearch コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/codesearch">
                      https://antigravity.google/docs/cli/commands/codesearch
                    </Ext>
                  </li>
                  <li>
                    /credits コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/credits">
                      https://antigravity.google/docs/cli/commands/credits
                    </Ext>
                  </li>
                  <li>
                    /diff コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/diff">
                      https://antigravity.google/docs/cli/commands/diff
                    </Ext>
                  </li>
                  <li>
                    /permissions コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/permissions">
                      https://antigravity.google/docs/cli/commands/permissions
                    </Ext>
                  </li>
                  <li>
                    /resume コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/resume">
                      https://antigravity.google/docs/cli/commands/resume
                    </Ext>
                  </li>
                  <li>
                    /statusline コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/statusline">
                      https://antigravity.google/docs/cli/commands/statusline
                    </Ext>
                  </li>
                  <li>
                    /title コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/title">
                      https://antigravity.google/docs/cli/commands/title
                    </Ext>
                  </li>
                  <li>
                    /usage コマンド詳細:{" "}
                    <Ext href="https://antigravity.google/docs/cli/commands/usage">
                      https://antigravity.google/docs/cli/commands/usage
                    </Ext>
                  </li>
                  <li>
                    Antigravity CLI 発表ブログ:{" "}
                    <Ext href="https://antigravity.google/blog/introducing-google-antigravity-cli">
                ...
                <ul>
                  <li>
                    ...
                    <Ext href="https://github.com/google-antigravity/antigravity-cli">
                ...
                <ul>
                  ...
                  <li>
                    サーフェス選択ガイド (CLI/IDE/SDK/2.0比較):{" "}
                    <Ext href="https://cloud.google.com/blog/topics/developers-practitioners/choosing-your-surface-antigravity-20-antigravity-cli-antigravity-ide-or-antigravity-sdk">
                  ...
                  <li>
                    Antigravity vs Gemini CLI 比較:{" "}
                    <Ext href="https://cloud.google.com/blog/topics/developers-practitioners/choosing-antigravity-or-gemini-cli">
                      https://cloud.google.com/blog/topics/developers-practitioners/choosing-antigravity-or-gemini-cli
                    </Ext>
                  </li>
                  <li>
                    Antigravity CLI チュートリアルシリーズ (Medium, Google Cloud Community):{" "}
                    <Ext href="https://medium.com/google-cloud/antigravity-cli-tutorial-series-12b46cfe3bf2">
                  ...
                  <li>
                    ...
                    <Ext href="https://medium.com/google-cloud/getting-started-with-antigravity-cli-26c5da90951f">
                      https://medium.com/google-cloud/getting-started-with-antigravity-cli-26c5da90951f
                    </Ext>
                  </li>
                  <li>
                    Antigravity CLI ハンズオン公式 Codelab:{" "}
                    <Ext href="https://codelabs.developers.google.com/genai-for-dev-antigravity-cli">
                      https://codelabs.developers.google.com/genai-for-dev-antigravity-cli
                    </Ext>
                  </li>
                  <li>
                    Antigravity CLI ハンズオン公式 Codelab (別編):{" "}
                    <Ext href="https://codelabs.developers.google.com/antigravity-cli-hands-on">
                ...
                <ul>
                  <li>
                    「15 Antigravity CLI tips」— YK氏 (Claude Code
                    tipsリポジトリ作者・9,000+スター、CS Dojo
                    YouTubeチャンネル創設者・登録者190万人超、Eventual社 Developer Experience
                    Manager)、Google Cloud Community寄稿:{" "}
                    <Ext href="https://medium.com/google-cloud/15-antigravity-cli-tips-ddbc21c10a20">
                      https://medium.com/google-cloud/15-antigravity-cli-tips-ddbc21c10a20
                    </Ext>
                  </li>
                  <li>
                    Simon Willison氏 (国際的に著名なAI/LLM評論家) によるGoogle
                    I/O・Antigravity関連の考察:{" "}
                    <Ext href="https://simonwillison.net/2026/May/20/google-io/">
              ...
              >
                ...
                <p>
                  本ガイドの内容は 2026 年 7 月 29 日時点の Antigravity CLI v1.1.5
                  以降の公開情報に基づきます。Antigravity CLI
                  は数週間単位でバージョンアップされており、コマンド名・設定キー・ファイルパスは変更される可能性があります。重要な自動化や
                  CI/CD 組み込みの前には、必ず <code>agy --help</code>{" "}
                  および公式ドキュメントの最新版を確認してください。
                </p>
              </div>
            </section>
          </div>
          ...
          <footer className={styles.pageFooter}>
            Antigravity CLI 完全ガイド — 2026-07-29 / v1.1.5+
            時点の公開情報にもとづく非公式リファレンス。図解はすべて Mermaid で描画。
          </footer>
        </main>
      </div>
    </div>
