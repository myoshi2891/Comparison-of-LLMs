...
export const metadata: Metadata = {
  ...
  description: "AIエージェント・API・コンテナ・C/C++・ブラウザ、5領域のサンドボックス技術のベストプラクティスをステップバイステップで解説するガイドライン。",
};
    ...
    <div className={styles.layout}>
      ...
      <nav className={styles.sidebar} id="sidebar">
        ...
        <ul className={styles.navList}>
          <li>
            <a href="#section-1">
              <span className={styles.navDot} />1. はじめに
            </a>
          </li>
          <li>
            <a href="#section-2">
              <span className={styles.navDot} />2. 全体マップ
            </a>
          </li>
          <li>
            <a href="#section-3">
              <span className={styles.navDot} style={{ "--dot": "var(--c-agent)" } as React.CSSProperties} />
              3. ① AIエージェント
            </a>
          </li>
          <li>
            <a href="#section-4">
              <span className={styles.navDot} style={{ "--dot": "var(--c-api)" } as React.CSSProperties} />
              4. ② API
            </a>
          </li>
          <li>
            <a href="#section-5">
              <span className={styles.navDot} style={{ "--dot": "var(--c-container)" } as React.CSSProperties} />
              5. ③ コンテナ
            </a>
          </li>
          <li>
            <a href="#section-6">
              <span className={styles.navDot} style={{ "--dot": "var(--c-cpp)" } as React.CSSProperties} />
              6. ④ C/C++
            </a>
          </li>
          <li>
            <a href="#section-7">
              <span className={styles.navDot} style={{ "--dot": "var(--c-browser)" } as React.CSSProperties} />
              7. ⑤ ブラウザ
            </a>
          </li>
          <li>
            <a href="#section-8">
              <span className={styles.navDot} />8. 意思決定フロー
            </a>
          </li>
          <li>
            <a href="#section-9">
              <span className={styles.navDot} />9. 横断ベストプラクティス
            </a>
          </li>
          <li>
            <a href="#section-10">
              <span className={styles.navDot} />10. 参考文献・出典URL
            </a>
          </li>
        </ul>
      </nav>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.quicknavGrid}>
          ...
          >
            ...
            <p className={styles.quicknavDesc}>Apigeeの環境分離とセキュリティポリシーでAPIレイヤーを保護</p>
          </a>
          <a
            className={styles.quicknavCard}
            href="#section-5"
          ...
          >
            ...
            <p className={styles.quicknavDesc}>Sandbox2とSandboxed API(SAPI)でネイティブライブラリを隔離</p>
          </a>
          <a
        ...
        <p>
          Googleはこの課題に対して、単一の万能な解決策ではなく、<strong>隔離したい対象のレイヤーごとに専用のサンドボックス技術を使い分ける</strong>という設計思想を取っています。本ガイドでは、その中でも特に問い合わせの多い次の5領域を、ステップバイステップのベストプラクティスとして整理します。
        </p>
        ...
        <p>
          ...
          Kubernetes Engine)向けの<strong>Agent Sandbox</strong>と、Gemini APIやAgent
          Platform向けの<strong>Code Execution</strong>という2つの製品ラインで解決しています。
        </p>
        <h3
          className={styles.domainH3}
        ...
        <p>
          ...
          Apps配下でオープンソース開発されているKubernetesネイティブな拡張機能です。gVisorによるカーネルレベルの隔離を、<code>Sandbox</code>・<code>SandboxTemplate</code>・<code>SandboxClaim</code>という3つの新しいKubernetesカスタムリソースを通じて提供します。
        </p>
        ...
        <p>
          Sentryはエージェントが発行するすべてのシステムコール(<code>exec</code>や<code>socket</code>など)を横取りし、ホストカーネルに直接触れさせない「偽のカーネル」として振る舞います。ファイルシステム操作だけは別プロセスのGoferが仲介するため、たとえSentryに未知の脆弱性があっても、ファイルシステムへの被害範囲を最小化できます。
        </p>
        <h3
          className={styles.domainH3}
        ...
        <p>
          GKE以外にも、Gemini APIおよびGemini Enterprise Agent Platformが提供する<strong
        ...
        <h2 className={styles.domainH2} id="4-領域②-apiのサンドボックス" style={{ "--domain": "var(--c-api)" } as React.CSSProperties}>
        ...
        <p>
          ...
          API管理製品)における「環境(environment)」は、<strong>APIプロキシを実行するための隔離されたコンテキスト</strong>を指し、公式ドキュメントでも「サンドボックス」と表現されています。1つの組織の中に複数の環境(開発用・テスト用・本番用など)を作成し、プロキシのデプロイ先を環境ごとに分離するのが基本設計です。
        </p>
        <div className={styles.mermaidWrap}>
        ...
        <ol type="1">
          ...
          <li>
            ...
            :プロキシ経由のリクエストでは<code>X-Forwarded-For</code>ヘッダーの保持設定が必要になるケースがあり、デフォルトのIP解決アルゴリズムが合わない場合は環境単位でカスタマイズできる
          </li>
          <li>
        ...
        <p>
          コンテナ領域におけるGoogleの主力技術は、AIエージェント領域でも登場した<strong>gVisor</strong>そのものです。通常のコンテナはホストカーネルを直接共有するため、1つのコンテナ内のカーネル脆弱性が、ノード全体・他の全コンテナに波及するリスクを抱えます。gVisorは、コンテナが発行するシステムコールをユーザー空間の「Sentry」で受け止め、seccomp-bpfによるシステムコールフィルタリングでさらに一段階の防御を重ねます。
        </p>
        <div className={styles.mermaidWrap}>
        ...
        <ol type="1">
          ...
          <li>
            ...
            :ノードプールのイメージタイプは「Container-Optimized OS with
            Containerd(<code>cos_containerd</code>)」のみがサポート対象
          </li>
          <li>
            <strong>RuntimeClassを確認する</strong>
            :ノードプール作成後、GKEが自動的に<code>gvisor</code>という名前のRuntimeClassを作成する。<code>kubectl get runtimeclass gvisor</code>で存在を確認する
          </li>
          <li>
        ...
        <h2 className={styles.domainH2} id="6-領域④-ccのサンドボックス" style={{ "--domain": "var(--c-cpp)" } as React.CSSProperties}>
        ...
        <p>
          ...
          Mode(seccomp)を拡張したLinuxカーネルの機能です。素のseccompは<code>exit</code>・<code>sigreturn</code>・<code>read</code>・<code>write</code>の4つしか許可しませんが、seccomp-bpfはBPF(Berkeley
          Packet
        ...
        <p>
          Sandbox2をそのまま使う場合、プロジェクトごとにポリシーやプロセス間のデータ交換の仕組みをゼロから設計し直す必要がありました。<strong>Sandboxed API(SAPI)</strong>はこの負担を解消するために作られたオープンソースプロジェクトで、Sandbox2を基盤にしながら「<strong>C/C++のライブラリ単位</strong>」でサンドボックス化できるようにします。開発チームのモットーは &quot;Sandbox once, use anywhere&quot;(一度サンドボックス化すれば、どこでも使い回せる)です。
        </p>
        <div className={styles.mermaidWrap}>
        ...
        <ol type="1">
          ...
          <li>
            <strong><code>sapi_library</code>ビルドルールを定義する</strong>
          ...
          <li>
            <strong>ホストコードをSAPI呼び出しに置き換える</strong>
            :<code>sapi::Sandbox</code>でサンドボックスオブジェクトを作成し、生成されたAPIクラス経由で関数を呼び出すようにホストコードを書き換える
          </li>
          <li>
            <strong>必要に応じて専用のsandbox policyを書く</strong>
            :デフォルトポリシーで足りない場合は、<code>sandbox.h</code>ヘッダーファイルに許可するシステムコール・ファイルアクセス範囲を定義し、<code>sapi_library</code>ルールに渡す
          </li>
          <li>
        ...
        <h3 className={styles.domainH3} id="6-4-cc領域における他の選択肢比較" style={{ "--domain": "var(--c-cpp)" } as React.CSSProperties}>
        ...
        <p>
          ...
          77(Android、ログイン済みサイト対象)からデフォルトで有効化されているのが<strong>Site Isolation</strong>
        ...
        <p>
          ...
          V3の<code>sandbox</code>プロパティを使うと、拡張機能内の特定のページを「一意のオリジンを持つサンドボックス」として動作させられます。
        </p>
        <ol type="1">
          <li>
            <strong><code>eval</code>やインラインスクリプトが必要なページだけをsandbox指定する</strong>
            :サンドボックス化されたページは拡張機能全体のCSP(コンテンツセキュリティポリシー)の対象外になり、独自のCSPを持てるため、<code>eval()</code>やインラインスクリプトの実行が可能になる
          </li>
          <li>
            <strong>拡張機能APIへの直接アクセスはできない前提で設計する</strong>
            :サンドボックス化ページは拡張機能API・非サンドボックスページへの直接アクセスができず、<code>postMessage()</code>経由でのみ通信できる
          </li>
          <li>
            <strong>CSPを絞り込む場合は<code>sandbox</code>ディレクティブを外さない</strong>
            :デフォルトのCSP値は<code>sandbox allow-scripts allow-forms allow-popups allow-modals; script-src &apos;self&apos; &apos;unsafe-inline&apos; &apos;unsafe-eval&apos;; child-src &apos;self&apos;;</code>。これをより厳しく絞り込むことは可能だが、<code>sandbox</code>ディレクティブ自体は必須で、<code>allow-same-origin</code>トークンは指定できない
          </li>
          <li>
            <strong>外部Webコンテンツの読み込みは避ける</strong>:Chrome
            57以降、サンドボックス化ページの中に外部Webコンテンツ(埋め込みフレーム・スクリプトを含む)を読み込むことはできない。外部コンテンツが必要な場合は<code>webview</code>を使う
          </li>
          <li>
            <strong>通常の拡張機能ページのCSPも最小権限に保つ</strong>
            :通常のページ(<code>extension_pages</code>)側では、Chromeが強制する最小CSP(<code>script-src &apos;self&apos; &apos;wasm-unsafe-eval&apos;; object-src &apos;self&apos;;</code>)より緩和することはできない仕様になっている
          </li>
        </ol>
        ...
        <div className={styles.tableScroll}>
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td><strong>状態管理/リソース制御</strong></td>
        ...
        <div className={styles.refGrid}>
          <div className={styles.refCard}>
            ...
            <ul>
              <li>
                ...
                <a href="https://developers.google.com/code-sandboxing" target="_blank" rel="noopener noreferrer">
                  https://developers.google.com/code-sandboxing
                </a>
              </li>
              <li>
                Sandbox2 Explained: <span className={styles.refIcon}>↗</span>
                <a href="https://developers.google.com/code-sandboxing/sandbox2/explained" target="_blank" rel="noopener noreferrer">
                  https://developers.google.com/code-sandboxing/sandbox2/explained
                </a>
              </li>
              <li>
                Sandboxed API (SAPI) 概要: <span className={styles.refIcon}>↗</span>
                <a href="https://developers.google.com/code-sandboxing/sandboxed-api" target="_blank" rel="noopener noreferrer">
                  https://developers.google.com/code-sandboxing/sandboxed-api
                </a>
              </li>
              <li>
                SAPI Explained: <span className={styles.refIcon}>↗</span>
                <a href="https://developers.google.com/code-sandboxing/sandboxed-api/explained" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <a href="https://developers.google.com/code-sandboxing/sandboxed-api/getting-started" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <a href="https://github.com/google/sandboxed-api" target="_blank" rel="noopener noreferrer">
          ...
          <div className={styles.refCard}>
            ...
            <ul>
              <li>
                GKE Sandbox(GKEセキュリティ公式ドキュメント): <span className={styles.refIcon}>↗</span>
                <a href="https://docs.cloud.google.com/kubernetes-engine/docs/concepts/sandbox-pods" target="_blank" rel="noopener noreferrer">
                  https://docs.cloud.google.com/kubernetes-engine/docs/concepts/sandbox-pods
                </a>
              </li>
              <li>
                Isolate AI code execution with Agent Sandbox: <span className={styles.refIcon}>↗</span>
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://google.github.io/adk-docs/safety/" target="_blank" rel="noopener noreferrer">
                  https://google.github.io/adk-docs/safety/
                </a>
              </li>
              <li>
                Code Execution(Gemini Enterprise Agent Platform公式): <span className={styles.refIcon}>↗</span>
                <a href="https://docs.cloud.google.com/gemini-enterprise-agent-platform/scale/sandbox/code-execution-overview" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://docs.cloud.google.com/gemini-enterprise-agent-platform/scale/sandbox" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <a href="https://ai.google.dev/gemini-api/docs/agents" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                Google Announces GKE Agent Sandbox and Hypercluster at Next &apos;26(InfoQ、Google Cloud AmbassadorのAlex Gkiouros氏の見解を含む):{" "}
                <span className={styles.refIcon}>↗</span>
              ...
              <li>
                Securing AI Agents on GKE(ARMO、Shauli Rozen氏): <span className={styles.refIcon}>↗</span>
                <a href="https://www.armosec.io/blog/sandboxing-ai-agents-gke-workload-identity/" target="_blank" rel="noopener noreferrer">
                  https://www.armosec.io/blog/sandboxing-ai-agents-gke-workload-identity/
                </a>
              </li>
              <li>
                GKE Agent SandboxとGKE Pod Snapshots(Rahul Ranganathan氏、Google Cloud Community/Medium ― ISOLATE/ACCELERATE/RESTRICTのフレームワークの出典):
                <span className={styles.refIcon}>↗</span>
              ...
              <li>
                Deploying Secure AI Agents on GKE(Google Codelabs): <span className={styles.refIcon}>↗</span>
                <a href="https://codelabs.developers.google.com/codelabs/gke/ai-agents-on-gke" target="_blank" rel="noopener noreferrer">
          ...
          <div className={styles.refCard}>
            ...
            <ul>
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://docs.cloud.google.com/architecture/best-practices-securing-applications-and-apis-using-apigee" target="_blank" rel="noopener noreferrer">
                  https://docs.cloud.google.com/architecture/best-practices-securing-applications-and-apis-using-apigee
                </a>
              </li>
              <li>
                Advanced API Security best practices(Apigee公式): <span className={styles.refIcon}>↗</span>
                <a href="https://docs.cloud.google.com/apigee/docs/api-security/best-practices" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://cloud.google.com/apigee/docs/hybrid/v1.9/environments-about" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://www.digitalapi.ai/blogs/what-are-the-best-practices-for-managing-a-sandbox-development-environment" target="_blank" rel="noopener noreferrer">
          ...
          <div className={styles.refCard}>
            ...
            <ul>
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://docs.cloud.google.com/kubernetes-engine/docs/how-to/sandbox-pods" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <a href="https://docs.cloud.google.com/run/docs/securing/security" target="_blank" rel="noopener noreferrer">
                  https://docs.cloud.google.com/run/docs/securing/security
                </a>
              </li>
              <li>
                Improved gVisor file system performance for GKE, Cloud Run, App Engine and Cloud Functions(Google Cloud Blog):{" "}
                <span className={styles.refIcon}>↗</span>
                <a href="https://cloud.google.com/blog/products/containers-kubernetes/gvisor-file-system-improvements-for-gke-and-serverless" target="_blank" rel="noopener noreferrer">
          ...
          <div className={styles.refCard}>
            ...
            <ul>
              ...
              <li>
                ...
                <a href="https://github.com/google/sandboxed-api/blob/main/README.md" target="_blank" rel="noopener noreferrer">
          ...
          <div className={styles.refCard}>
            ...
            <ul>
              <li>
                Site Isolation Design Document(Chromium公式): <span className={styles.refIcon}>↗</span>
                <a href="https://www.chromium.org/developers/design-documents/site-isolation/" target="_blank" rel="noopener noreferrer">
                  https://www.chromium.org/developers/design-documents/site-isolation/
                </a>
              </li>
              <li>
                Secure Architecture(Chromium Security公式): <span className={styles.refIcon}>↗</span>
                <a href="https://www.chromium.org/Home/chromium-security/guts/" target="_blank" rel="noopener noreferrer">
                  https://www.chromium.org/Home/chromium-security/guts/
                </a>
              </li>
              <li>
                The V8 Sandbox(V8公式ブログ、Samuel Groß氏): <span className={styles.refIcon}>↗</span>
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://saelo.github.io/presentations/offensivecon_24_the_v8_heap_sandbox.pdf" target="_blank" rel="noopener noreferrer">
                  https://saelo.github.io/presentations/offensivecon_24_the_v8_heap_sandbox.pdf
                </a>
              </li>
              <li>
                Google Chrome Adds V8 Sandbox(The Hacker News): <span className={styles.refIcon}>↗</span>
                <a href="https://thehackernews.com/2024/04/google-chrome-adds-v8-sandbox-new.html" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://developer.chrome.com/docs/extensions/reference/manifest/sandbox" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                ...
                <span className={styles.refIcon}>↗</span>
                <a href="https://developer.chrome.com/docs/extensions/reference/manifest/content-security-policy" target="_blank" rel="noopener noreferrer">
                  https://developer.chrome.com/docs/extensions/reference/manifest/content-security-policy
                </a>
              </li>
              <li>
                Cleanly Escaping the Chrome Sandbox(Theori Blog): <span className={styles.refIcon}>↗</span>
                <a href="https://theori.io/blog/cleanly-escaping-the-chrome-sandbox" target="_blank" rel="noopener noreferrer">
