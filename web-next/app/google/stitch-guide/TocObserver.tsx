...
export default function TocObserver() {
  useEffect(() => {
    const sections = document.querySelectorAll("section.stitchSection");
    ...
    const toggle = document.getElementById("stitchNavToggle");
    const list = document.getElementById("stitchNavList");

    if (toggle && list) {
      toggle.setAttribute("aria-controls", "stitchNavList");
