...
import PageComponent, { metadata as rawMetadata } from "@/app/google/stitch-guide/page";
...
describe("/google/stitch-guide - metadata", () => {
  it("exports a metadata object with title containing 'Google Stitch 実践ガイド'", () => {
...
describe("/google/stitch-guide - page structure", () => {
  it("renders an <h1> containing 'Google Stitch 実践ガイド'", () => {
    const { container } = render(<Page />);
    const h1 = container.querySelector("h1");
    expect(h1).not.toBeNull();
    expect(h1?.textContent).toContain("Google Stitch 実践ガイド");
  });
...
describe("/google/stitch-guide - external link safety", () => {
...
describe("/google/stitch-guide - code block validation", () => {
...
describe("/google/stitch-guide - static source safety", () => {
