...
export default function ItilAiGovernancePage() {
  return (
    <div className={styles.layout}>
      ...
      />
      <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fontsource/inter@5.3.0/index.css" />
      ...
      <div className={styles.brand}>
        ...
        <div className={styles.brandText}>
          ITIL AI Governance<br />(Version 5)
    ...
    <div className={styles.main}>
      <div className={styles.prose}>
        ...
        <h3 className={styles.subtitle}>初学者向け ステップバイステップ解説 + ベストプラクティス集</h3>
        ...
        <ol>
          <li><strong>概念解説</strong> — 専門用語（英語表記を保持）を丁寧に噛み砕いて説明</li>
          <li><strong>ベストプラクティス</strong> — 実務でその概念をどう活かすかの具体的な指針</li>
          <li><strong>ソース</strong> — 主張の根拠となる一次情報・公式情報源の URL</li>
        </ol>
        <div className={`${styles.callout} ${styles.note}`} data-testid="callout" data-variant="note">
          <div className={styles.calloutHead}><i className="ti ti-info-circle" /><span>補足</span></div>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            ...
            <tr>
              <td>前提条件</td>
              <td><strong>なし</strong>（ITIL Foundation 未取得でも受験可能）</td>
            </tr>
            <tr>
              <td>出題数</td>
              <td>40問</td>
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          <div className={styles.calloutHead}><i className="ti ti-external-link" /><span>ソース</span></div>
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://www.peoplecert.org/browse-certifications/it-governance-and-service-management/ITIL-1/itil-ai-governance-version-5-4234" target="_blank" rel="noopener noreferrer"
                >PeopleCert 公式製品ページ</a
              >,
              <a href="https://itsmacademy.com/itil-ai-governance-course" target="_blank" rel="noopener noreferrer">ITSM Academy コース概要</a
              >, <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer">AGILEPM HUB コース概要</a>
            </p>
          </div>
        </div>
        <h3>全体像（この資格で学ぶ主要モデル）</h3>
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_0} /></div>
        <hr className={styles.divider} />
        <h2 id="第1章-AI-の世界と-AI-ガバナンスの必要性">
          第1章: AI の世界と AI ガバナンスの必要性
        </h2>
        <p><em>(Module 1: The AI World and the Need for AI Governance)</em></p>
        <h3>1-1. なぜ今 AI ガバナンスが必要なのか</h3>
        <p>
          生成AI・エージェント型AIの普及により、組織の意思決定・業務運用・サービス提供の多くの場面で
          AI が関与するようになりました。PeopleCert の公式紹介ページによれば、GenAI に投資した組織の
          <strong>95%が投資対効果（ROI）を実感できていない</strong>、専門職の
          <strong
            >46%が機密情報や知的財産を一般公開の AI
            プラットフォームにアップロードしたことがある</strong
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://www.peoplecert.org/browse-certifications/it-governance-and-service-management/ITIL-1/itil-ai-governance-version-5-4234" target="_blank" rel="noopener noreferrer"
                >PeopleCert 公式ページ「Why certify now」</a
              >
            </p>
          </div>
        </div>
        ...
        <p>
          ...
          を「魔法の道具」としてではなく、統治対象となる<strong>能力（Capability）の集合体</strong>として捉え直すことです。
        </p>
        ...
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_1} /></div>
        <p>
          この進行に伴って必要な統治の水準（人間の監督範囲、意思決定権限の委譲範囲など）も段階的に変化していきます。<strong
            >AI
            が「同僚」や「ワークフォースの一員」に近づくほど、事前に定義された裁量の境界（decision
            boundaries）と、逸脱を検知する仕組みが不可欠になる</strong
          >、というのが本章の重要な着眼点です。
        </p>
        ...
        <div className={`${styles.callout} ${styles.practice}`} data-testid="callout" data-variant="practice">
          <div className={styles.calloutHead}><i className="ti ti-bulb" /><span>ベストプラクティス</span></div>
          <div className={styles.calloutBody}>
            <ul>
              <li>
                AI
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://itsmacademy.com/itil-ai-governance-course" target="_blank" rel="noopener noreferrer"
                >ITSM Academy コースアウトライン (Module 1)</a
              >,
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer"
                >AGILEPM HUB シラバス (Module 1)</a
              >
            </p>
          </div>
        </div>
        ...
        <p><em>(Module 2: Key Concepts of Governance)</em></p>
        ...
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_2} /></div>
        <p>
          さらに本章では、<strong>コーポレートガバナンス（企業全体の統治）</strong>、<strong>ITガバナンス（IT資源の統治）</strong>、<strong
            >AIガバナンス（AI能力に特化した統治）</strong
          >
          の関係が整理されます。AI ガバナンスは IT ガバナンスの単なる一部ではなく、AI
          特有の性質（自律性・学習性・不透明性）に対応する<strong>専用の統治レイヤー</strong>として位置づけられます。これが「なぜ従来の
          IT ガバナンスだけでは不十分なのか（Why IT governance is insufficient）」という、後の
          Module 6 につながる重要な伏線です。
        </p>
        ...
        <p>
          ITIL AI Governance のシラバスで特に重要なのが、<strong
            >4つのガバナンスパターン（four governance patterns）</strong
          >です。これは「誰が・どの程度の裁量を持って AI
          の意思決定を行うか」を分類する枠組みで、複数の公式トレーニングパートナー資料で一貫して次の4種類として説明されています。
        </p>
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_3} /></div>
        <table className={styles.table}>
          <thead>
            <tr>
              <th>パターン</th>
          ...
          <tbody>
            ...
            <tr>
              <td><strong>Autonomous（自律型）</strong></td>
        ...
        <div className={`${styles.callout} ${styles.practice}`} data-testid="callout" data-variant="practice">
          ...
          <div className={styles.calloutBody}>
            <ul>
              <li>
                全社で単一のガバナンスパターンに固定するのではなく、<strong
                  >AI ユースケースのリスクレベルに応じてパターンを使い分ける</strong
                >。
              </li>
              <li>
                Federated
        ...
        <ul>
          <li><strong>統制（Control）</strong></li>
          <li><strong>リスク管理（Risk management）</strong></li>
          <li><strong>コンプライアンス（Compliance）</strong></li>
          <li><strong>説明責任（Accountability）</strong></li>
          <li><strong>スチュワードシップ（Stewardship）</strong></li>
          <li><strong>価値創出（Value creation）</strong></li>
        </ul>
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          <div className={styles.calloutHead}><i className="ti ti-external-link" /><span>ソース</span></div>
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer">AGILEPM HUB シラバス (Module 2)</a
              >,
              <a href="https://itsmacademy.com/itil-ai-governance-course" target="_blank" rel="noopener noreferrer"
                >ITSM Academy コースアウトライン (Module 2)</a
              >
            </p>
          </div>
        </div>
        ...
        <p><em>(Module 3: Key Concepts of AI and Why We Need AI Governance)</em></p>
        <h3>3-1. AI の3つのタイプ</h3>
        <p>ITIL AI Governance では AI を大きく3つのタイプに分類します。</p>
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_4} /></div>
        <table className={styles.table}>
          <thead>
            <tr>
              <th>タイプ</th>
          ...
          <tbody>
            <tr>
              <td><strong>Narrow AI</strong>（特化型）</td>
              <td>定義された1つのタスクを高精度でこなす。予測・分類など</td>
              <td>精度低下・バイアスの監視</td>
            </tr>
            <tr>
              <td><strong>Generative AI</strong>（生成）</td>
              <td>新しいテキスト・画像・コードなどを生成する</td>
              <td>ハルシネーション、著作権、出力の事実確認</td>
            </tr>
            <tr>
              <td><strong>Agentic AI</strong>（エージェント型）</td>
        ...
        <ul>
          <li><strong>自律性（Autonomy）</strong>: 人間の介入なしにどこまで判断・行動できるか</li>
          <li>
        ...
        <p>
          この3特性が高くなるほど、統治の難易度は上がります。特に <strong>Agentic AIOps</strong>（AI
          エージェントを IT
        ...
        <div className={`${styles.callout} ${styles.practice}`} data-testid="callout" data-variant="practice">
          ...
          <div className={styles.calloutBody}>
            <ul>
              ...
              <li>
                Agentic AI
                を業務に組み込む際は、上記7つの統治上の問い（許可行動・除外・上書き・ログ・責任・監視・ロールバック）を<strong>導入前チェックリスト</strong>として文書化する。
              </li>
              <li>
                AI
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer">AGILEPM HUB シラバス (Module 3)</a
              >,
              <a href="https://itsmacademy.com/itil-ai-governance-course" target="_blank" rel="noopener noreferrer"
                >ITSM Academy コースアウトライン (Module 3)</a
              >
            </p>
          </div>
        </div>
        ...
        <p><em>(Module 4: Risk, Strategy, and the Consequences of Getting It Wrong)</em></p>
        <h3>4-1. 6C モデルとは</h3>
        <p>
          <strong>ITIL AI Capability Model（通称「6C モデル」）</strong>は、ITIL (Version 5) の Four
          Dimensions のうち「Information and Technology」次元に新設された枠組みで、AI
          システムが<strong>何をしているか</strong>を6つの機能カテゴリで分類します。
        </p>
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_5} /></div>
        <table className={styles.table}>
          <thead>
            <tr>
              <th>能力 (Capability)</th>
        ...
        <div className={`${styles.callout} ${styles.note}`} data-testid="callout" data-variant="note">
          <div className={styles.calloutHead}><i className="ti ti-info-circle" /><span>補足</span></div>
          <div className={styles.calloutBody}>
            <p><strong>なぜ Communication に IEEE 7014-2024 が関係するのか</strong></p>
            <p>
        ...
        <p>
          6C の各能力は、リスクの種類・大きさが異なるため、<strong
            >統治の境界線（governance boundaries）</strong
          >もそれぞれ異なります。例えば、同じ「AIチャットボット」でも、単純な FAQ
          回答（Communication
          のみ）と、そこから自動でチケットをクローズしたりシステム変更を実行したりする機能（Communication
          + Coordination
          の組み合わせ）とでは、必要な統制の強度が全く異なります。<strong>複数の能力が組み合わさるほど、リスクは単純な足し算ではなく複合的に増大する</strong>という考え方（combined
          behavior）が重要です。
        </p>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            <tr>
              <td>
                <strong>意思決定権限とリスク管理</strong><br />(Decision authority &amp; risk
                management)
              </td>
            ...
            <tr>
              <td><strong>倫理原則</strong><br />(Ethical principles)</td>
              <td>バイアス・説明可能性・組織の価値観との整合は取れているか</td>
              <td>バイアステスト、判断の説明可能性(explainability)確保</td>
            </tr>
            <tr>
              <td>
                <strong>データガバナンスとパフォーマンス管理</strong><br />(Data Governance &amp;
            ...
            <tr>
              <td>
                <strong>規制コンプライアンスと運用標準</strong><br />(Regulatory Compliance &amp;
        ...
        <p>
          これら4つの視点は独立ではなく<strong>相互依存的（interdependent）</strong>です。例えば、倫理原則で定めた透明性要件が、規制コンプライアンス（EU
          AI Act
        ...
        <p>
          Module 4 では、AI
          リスクカテゴリ（バイアス・プライバシー・ハルシネーション・不透明性など）を「<strong
            >AI capability risk heatmap</strong
          >」として 6C
        ...
        <p>
          ...
          が組織の戦略的な整合性（strategy and alignment）をどう損なうかが扱われ、これは Module 6・7
          で扱う「Shadow AI 統制の設計」に直結します。
        </p>
        <div className={`${styles.callout} ${styles.practice}`} data-testid="callout" data-variant="practice">
          <div className={styles.calloutHead}><i className="ti ti-bulb" /><span>ベストプラクティス</span></div>
          <div className={styles.calloutBody}>
            <ul>
              ...
              <li>
                4つのガバナンス視点（意思決定権限／倫理／データ／規制）を<strong>チェックリスト化</strong>し、AI
                導入の承認プロセスに組み込む。
              </li>
              <li>
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer">AGILEPM HUB シラバス (Module 4)</a
              >, <a href="https://itcko.sk/en/itil-v5-ai-governance-module/" target="_blank" rel="noopener noreferrer">itcko.sk 解説記事</a>,
              <a href="https://www.pmgacademy.com/en/articles/itil/information-and-technology-in-itil-version-5-the-guide-for-the-ai-era-and-data-governance/" target="_blank" rel="noopener noreferrer"
                >PMG Academy 6C モデル解説</a
              >, <a href="https://standards.ieee.org/ieee/7014/7648/" target="_blank" rel="noopener noreferrer">IEEE 7014-2024</a>
            </p>
          </div>
        </div>
        <hr className={styles.divider} />
        ...
        <p><em>(Module 5: ITIL as a Governance Toolkit)</em></p>
        ...
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_6} /></div>
        ...
        <p>
          ...
          として再構成されています。AI（特に 6C
          の各能力）は、このライフサイクルの<strong>あらゆる段階</strong>を支援しうるとされ、例えば計画段階での需要予測（Cognition）、設計段階でのコード生成（Creation）、運用段階でのインシデント要約（Clarification）などが該当します。重要なのは、<strong
            >AI ガバナンスはライフサイクルの一部の段階だけでなく、全段階に一貫して適用される</strong
          >という考え方です。
        </p>
        ...
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_7} /></div>
        <ul>
          <li>
        ...
        <p>
          AI
          の価値評価には、環境負荷（計算資源の消費など）を含む<strong>サステナビリティ（持続可能性）</strong>の観点も明示的に含まれます。AI
          導入の ROI
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://itsmacademy.com/itil-ai-governance-course" target="_blank" rel="noopener noreferrer"
                >ITSM Academy コースアウトライン (Module 5)</a
              >,
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer">AGILEPM HUB シラバス (Module 5)</a
              >,
              <a href="https://itsm.tools/itil-version-5-vs-itil-4-key-changes/" target="_blank" rel="noopener noreferrer"
                >ITIL (Version 5) の変更点まとめ</a
              >
            </p>
          </div>
        </div>
        ...
        <p>
          ...
          特有の自律性・学習性・不透明性に対応しきれません。<strong
            >ITIL AI Governance Improvement Model</strong
          >
          は、AI
          ガバナンスを一過性の対応ではなく、継続的に評価・調整するための4ステップの改善サイクルとして提供します。
        </p>
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_8} /></div>
        <p>
          本章（Module 6）では前半の <strong>Assess</strong> と
          <strong>Design</strong> を扱い、第7章（Module 7）で後半の <strong>Implement</strong> と
          <strong>Maintain</strong> を扱います。
        </p>
        ...
        <p>
          すべての AI ユースケースに同じ強度の統制をかけるのは非効率です。<strong
            >比例的ガバナンス（proportionate governance）</strong
        ...
        <table className={styles.table}>
          ...
          <tbody>
            <tr>
              <td><strong>高い (High)</strong></td>
              <td>中リスク</td>
              <td>高リスク</td>
              <td><strong>最優先で統制</strong></td>
            </tr>
            <tr>
              <td><strong>中程度 (Medium)</strong></td>
              <td>低リスク</td>
              <td>中リスク</td>
              <td>高リスク</td>
            </tr>
            <tr>
              <td><strong>低い (Low)</strong></td>
              <td>最小限の統制で可</td>
              <td>低リスク</td>
              <td>中リスク</td>
            </tr>
        ...
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_9} /></div>
        <table className={styles.table}>
          <thead>
            <tr>
              <th>統制タイプ</th>
          ...
          <tbody>
            <tr>
              <td><strong>Preventive（予防的）</strong></td>
              <td>問題の発生自体を防ぐ</td>
              <td>
            ...
            <tr>
              <td><strong>Detective（発見的）</strong></td>
              <td>発生した問題を早期に検知する</td>
              <td>出力の異常検知アラート、モデルドリフトの自動監視</td>
            </tr>
            <tr>
              <td><strong>Corrective（是正的）</strong></td>
        ...
        <div className={`${styles.callout} ${styles.practice}`} data-testid="callout" data-variant="practice">
          ...
          <div className={styles.calloutBody}>
            <ul>
              ...
              <li>
                決定境界は「文章」だけでなく、可能な限り<strong>システム上の技術的な制約（ハードな境界）</strong>として実装する。人間の運用ルール順守だけに頼らない。
              </li>
            </ul>
          </div>
        </div>
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://itsmacademy.com/itil-ai-governance-course" target="_blank" rel="noopener noreferrer"
                >ITSM Academy コースアウトライン (Module 6)</a
              >,
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer"
                >AGILEPM HUB シラバス (Module 6)</a
              >
            </p>
          </div>
        </div>
        ...
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_10} /></div>
        <ul>
          <li>
            <strong
              >可観測性（Observability）・監視（Monitoring）・監査可能性（Auditability）</strong
            >: AI
        ...
        <p>
          規制・コンプライアンス要件は、統制を設計した後に確認するものではなく、<strong
            >Design・Implement・Maintain 全体を貫く入力（input）</strong
          >として扱われます。
        </p>
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_11} /></div>
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer">AGILEPM HUB シラバス (Module 7)</a
              >, <a href="https://itcko.sk/en/itil-v5-ai-governance-module/" target="_blank" rel="noopener noreferrer">itcko.sk 解説記事</a>,
              <a href="https://www.iso.org/standard/81230.html" target="_blank" rel="noopener noreferrer">ISO/IEC 42001 公式ページ</a>,
              <a href="https://standards.ieee.org/ieee/7014/7648/" target="_blank" rel="noopener noreferrer">IEEE 7014-2024 公式ページ</a>,
              <a href="https://eur-lex.europa.eu/eli/reg/2024/1689/oj" target="_blank" rel="noopener noreferrer"
                >EU AI Act 法令本文 (EUR-Lex)</a
              >
            </p>
          </div>
        </div>
        ...
        <ul>
          ...
          <li><strong>金融・与信</strong>: 与信判断支援（Cognition）※説明可能性・規制対応が必須</li>
          <li><strong>製造・運用</strong>: 予知保全（Cognition）、マニュアル生成（Creation）</li>
        </ul>
        <h3>8-3. AI ユースケース評価テンプレート</h3>
        <p>
          Module 8 では、シナリオを解釈し、AI
          ユースケースを体系的にアセスメントするための包括的なテンプレート（full AI use-case
          assessment template）が扱われます。このテンプレートには、少なくとも次の要素が含まれます。
        </p>
        <table className={styles.table}>
          <thead>
            <tr>
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer">AGILEPM HUB シラバス (Module 8)</a
              >,
              <a href="https://itsmacademy.com/itil-ai-governance-course" target="_blank" rel="noopener noreferrer"
                >ITSM Academy コースアウトライン (Module 8)</a
              >
            </p>
          </div>
        </div>
        ...
        <p>
          <em>(Module 9: Connecting AI Governance with Frameworks, Regulations, and Standards)</em>
        </p>
        ...
        <p>
          ...
          42001、IEEE
          7014-2024）は、それぞれ<strong>異なる問い（question）に答える</strong>ために存在します。Module
          9 では、これらが競合するのではなく補完し合う関係にあることを理解します。
        </p>
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_12} /></div>
        <table className={styles.table}>
          <thead>
            <tr>
              <th>フレームワーク／標準</th>
          ...
          <tbody>
            <tr>
              <td><strong>ITIL (AI Governance)</strong></td>
              <td>AIをどう責任を持って統治し、価値創出とリスク管理を両立させるか</td>
            </tr>
            <tr>
              <td><strong>PRINCE2</strong></td>
            ...
            <tr>
              <td><strong>IEEE 7014-2024</strong></td>
              <td>AIによる模倣共感をどう倫理的に設計・運用するか</td>
            </tr>
            <tr>
              <td><strong>各国規制 (EU AI Act 等)</strong></td>
        ...
        <p>
          DevOps の CI/CD
          パイプラインに、ガバナンス上のチェック（バイアステスト、セキュリティスキャン、決定境界の自動検証など）を<strong>技術的なゲート</strong>として組み込むことで、「ガバナンスがデリバリー速度を落とす」という対立構造を避け、「安全に速く届ける（DevSecOps
          的発想の AI
        ...
        <div className={styles.diagramWrap}><MermaidDiagram chart={DIAGRAM_13} /></div>
        <div className={`${styles.callout} ${styles.practice}`} data-testid="callout" data-variant="practice">
          <div className={styles.calloutHead}><i className="ti ti-bulb" /><span>ベストプラクティス</span></div>
          <div className={styles.calloutBody}>
            <ul>
        ...
        <div className={`${styles.callout} ${styles.source}`} data-testid="callout" data-variant="source">
          ...
          <div className={styles.calloutBody}>
            <p>
              出典:
              <a href="https://agilepmhub.com/itil-ai-governance" target="_blank" rel="noopener noreferrer">AGILEPM HUB シラバス (Module 9)</a
              >,
              <a href="https://itsmacademy.com/itil-ai-governance-course" target="_blank" rel="noopener noreferrer"
                >ITSM Academy コースアウトライン (Module 9)</a
              >
            </p>
          </div>
        </div>
        ...
        <ul>
          ...
          <li>
            <strong>シナリオベース出題への対策</strong>: 実在の企業を想定した架空シナリオ（"ITIL Car
            Rental Scenario"
        ...
        <table className={styles.table}>
          ...
          <tbody>
            ...
            <tr>
              <td>5</td>
              <td>ITIL Value System、Four Dimensions への AI の組み込まれ方、Guiding Principles</td>
            </tr>
            <tr>
              <td>6</td>
              <td>
            ...
            <tr>
              <td>7</td>
              <td>Improvement Model の Implement/Maintain、EU AI Act・ISO42001・IEEE7014 の役割</td>
            </tr>
            <tr>
              <td>8</td>
        ...
        <div className={styles.refList}>
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">1</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
          ...
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">2</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
          ...
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">3</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
                href="https://www.axelos.com/best-practice-solutions/itil"
                target="_blank"
                rel="noopener"
                >AXELOS ITIL ベストプラクティスページ</a
              >

              <div className={styles.refUrl}>https://www.axelos.com/best-practice-solutions/itil</div>
            </div>
          </div>
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">4</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
                href="https://www.iso.org/standard/81230.html"
                target="_blank"
                rel="noopener"
                >ISO/IEC 42001:2023 公式ページ</a
              >
          ...
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">5</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
                href="https://standards.ieee.org/ieee/7014/7648/"
                target="_blank"
                rel="noopener"
                >IEEE 7014-2024 公式ページ</a
              >
          ...
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">6</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
        ...
        <div className={styles.refList}>
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">7</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
                href="https://itsmacademy.com/itil-ai-governance-course"
                target="_blank"
                rel="noopener"
                >ITSM Academy コース詳細</a
              >
              <div className={styles.refNote}>PeopleCert認定ATO、全9モジュールアウトライン</div>
              <div className={styles.refUrl}>https://itsmacademy.com/itil-ai-governance-course</div>
            </div>
          </div>
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">8</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
                ...
                >AGILEPM HUB コース詳細</a
              >
              <div className={styles.refNote}>PeopleCert認定ATO、全9モジュールアウトライン・試験詳細</div>
              <div className={styles.refUrl}>https://agilepmhub.com/itil-ai-governance</div>
            </div>
          </div>
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">9</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
              ...
              <div className={styles.refUrl}>https://itcko.sk/en/itil-v5-ai-governance-module/</div>
            </div>
          </div>
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">10</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
          ...
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">11</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
                href="https://www.innovativelearning.eu/products/itil-5/itil-ai-governance-5.html"
                target="_blank"
                rel="noopener"
                >Innovative Learning コース概要</a
              >
          ...
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">13</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
              ...
              <div className={styles.refUrl}>https://itsm.tools/itil-version-5-vs-itil-4-key-changes/</div>
            </div>
          </div>
          <div className={styles.refCard} data-testid="ref-card">
            <div className={styles.refBadge} data-testid="ref-badge">14</div>
            <div className={styles.refBody}>
              <a className={styles.refTitle}
        ...
        <div className={`${styles.callout} ${styles.note}`} data-testid="callout" data-variant="note">
          <div className={styles.calloutHead}><i className="ti ti-info-circle" /><span>免責事項</span></div>
          <div className={styles.calloutBody}>
            <p>
