...
import MicrosoftFoundryBestPracticesIntermediatePage, { metadata } from "./page";

describe("MicrosoftFoundryBestPracticesIntermediatePage", () => {
  it("exports proper metadata", () => {
    expect(metadata.title).toBe("Microsoft Foundry 実践ベストプラクティスガイド");
  ...
  it("renders h1 and 17 h2 section titles", () => {
    const { container } = render(<MicrosoftFoundryBestPracticesIntermediatePage />);
    const h1 = container.querySelector("h1");
    expect(h1?.textContent).toContain("Microsoft Foundry 実践ベストプラクティスガイド");
