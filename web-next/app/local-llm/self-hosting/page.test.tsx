...
import PageComponent, { metadata as rawMetadata } from "@/app/local-llm/self-hosting/page";
...
describe("/local-llm/self-hosting - metadata", () => {
  it("exports a metadata object with title containing 'ローカルLLM/セルフホスティング 完全ガイド'", () => {
...
describe("/local-llm/self-hosting - page structure", () => {
  it("renders an <h1> containing 'ローカルLLM/セルフホスティング 完全ガイド'", () => {
    const { container } = render(<Page />);
    const h1 = container.querySelector("h1");
    expect(h1).not.toBeNull();
    expect(h1?.textContent).toBe("ローカルLLM/セルフホスティング 完全ガイド");
  });
...
describe("/local-llm/self-hosting - external link safety", () => {
...
describe("/local-llm/self-hosting - static source safety", () => {
