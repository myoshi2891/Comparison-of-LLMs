...
export default function TocObserver() {
  useEffect(() => {
    ...
    const toggle = document.getElementById("mcpInterNavToggle");
    const list = document.getElementById("mcpInterNavList");

    if (toggle && list) {
      toggle.setAttribute("aria-controls", "mcpInterNavList");
