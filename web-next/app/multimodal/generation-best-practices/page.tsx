      ...
      <div className={styles.layout}>
        ...
        <main className={styles.content}>
          ...
          <section id="s4" className={`${styles.chapter} chapter`}>
            ...
            <p>
              写真的なリアリズムを狙う場合は、カメラ用語を積極的に使うのがコツです。レンズプロファイル(35mmレンズ、85mmポートレート単焦点など)を明示し、肌のキメや埃の粒子といった表面のディテール、光の自然な散乱を描写することで、被写界深度や自然な陰影を再現しやすくなります。具体的には「85mmレンズ、f/1.8、特定のフィルムストック、シネマティックなリムライト」のように、レンズ・絞り・フィルム・照明を具体的に指定する手法が写管理的リアリズムの鍵とされています。
            </p>
          ...
          <section id="s5" className={`${styles.chapter} chapter`}>
            ...
            <ul className={styles.plainList}>
              ...
              <li>
                著作権保護のため、実造アーティスト名を直接プロンプトに書くことはできません。代わりに、そのアーティストに近い音楽性を表す一般的なスタイル記述語(ジャンル・年代・質感など)を使うのが一般的な回避策です。
              </li>
            </ul>
