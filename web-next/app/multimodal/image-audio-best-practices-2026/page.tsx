...
F --> G
G --> H{"出力メディアのサポート判定"}
H -->|"画像 (C2PA/SynthID)"| H1["C2PA署名 & SynthID透かし埋め込み"]
H -->|"音声 (SynthID等)"| H2["音声透かし埋め込み (SynthID for Audio等)"]
H -->|"非対応メディア"| H3["代替フロー: 独自メタデータ付与 / 検証用ハッシュ記録"]
H1 --> I["ユーザーへ配信"]
H2 --> I
H3 --> I`,
      ...
      <div className={styles.layout}>
        ...
        <main className={styles.content}>
          ...
          <section className="chapter" id="s5">
            ...
            <p>
              LoRAは既存のAIモデルに小さな部品（アダプター）だけを足して新しいスタイルやキャラクターを覚えさせる手法で、元のモデルはそのまま残し、その横に薄い「メモ帳」を挟むイメージであり、学習するパラメータ量が少なくGPU負荷も小さく、生成されるファイルも数MB〜数百MBと軽量です。フルのファインチューニングの10%のコストで95%相当の性能を達成できるというデータも公開されています。
            </p>
