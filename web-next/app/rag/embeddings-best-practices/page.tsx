  ...
  return (
    <div className={styles.pageWrap}>
        ...
        <main className={styles.content}>
          ...
          <section className={`${styles.section} chapter`} id="sec-1">
            ...
            <p>
              ...
              Generation、検索拡張生成)は、LLM(大規模言語モデル)が回答を生成する前に、外部の知識ソース(社内ドキュメント、PDF、データベースなど)から関連情報を検索し、その情報を根拠として回答を組み立てるアーキテクチャです。
            </p>
            <p>
            ...
            <p>
              RAGという用語自体は、2020年にMeta AI(当時のFacebook AI Research)のPatrick Lewisらが
              NeurIPS
              で発表した論文で提案されました。この論文では、事前学習済みのretriever(検索器)とgenerator(生成器)を組み合わせることで、生成器単体よりも事実性・多様性・具体性に優れた回答が得られることが示されました。
            </p>
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://decodethefuture.org/en/rag/">
              ...
              <Ext href="https://www.techment.com/blogs/rag-in-2026/">
                https://www.techment.com/blogs/rag-in-2026/
              </Ext>
              <Ext href="https://nerdleveltech.com/guides/rag-systems">
          ...
          <section className={`${styles.section} chapter`} id="sec-2">
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td>①パース&amp;クリーニング</td>
                    <td>
                      PDF/HTML/Markdownからテキストを抽出し、ヘッダー・フッター等のノイズを除去
                    </td>
                    <td>4章</td>
                  </tr>
                  <tr>
            ...
            <ol className={styles.navListInline}>
              <li>
                <strong>意味的ギャップ(Semantic gap)</strong>:
                ユーザーの言葉と文書中の言葉が異なる(例:「解約したい」 vs
                文書中の「アカウント終了ポリシー」)
              </li>
              <li>
                <strong>コンテキスト汚染</strong>:
                関連チャンクが2件しかないのに10件取得すると、LLMが全体を平均化し回答が曖昧になる
              </li>
              <li>
                <strong>チャンキングの副作用</strong>:
                固定長分割で文・表・コードの途中が切れ、取得できても実質使えないチャンクになる
              </li>
            </ol>
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://aiml.qa/vector-database-comparison-2026/">
          ...
          <section className={`${styles.section} chapter`} id="sec-3">
            ...
            <p>
              例えば「software
              engineer」と「developer」という単語は表記が異なりますが、Embeddingベクトル上では非常に近い位置に配置されます。これにより、キーワードが完全一致しなくても「意味的に近い」文書を検索できるようになります。
            </p>
            ...
            <p>
              2026年時点で主要なEmbeddingモデルのほとんどが採用しているのが
              <strong>Matryoshka Representation Learning(MRL)</strong>
              という学習手法です。ロシアの入れ子人形(マトリョーシカ)のように、1つのベクトルの前半部分だけを切り出しても意味的に重要な情報が保持されるよう学習します。
            </p>
            <p>
            ...
            <p>
              <strong>MTEB(Massive Text Embedding Benchmark)</strong>
              は、Embeddingモデルの性能を測る業界標準のベンチマークで、検索・分類・クラスタリング・意味的類似度(STS)など複数のタスクにまたがる評価を行います。ただし複数の実務ガイドが「MTEBの総合スコアだけで選ぶのは危険」と警告しています。MTEBは平均的なタスク性能を示すものであり、法律文書・医療文献・多言語コーパスなど特定ドメインでの実際の検索精度とは乖離することがあるためです。自社データ・自社クエリでのオフライン評価(9章のRAGAS等)と組み合わせて判断することが推奨されています。
            </p>
            ...
            <p>
              Dense(意味検索)だけでは、「SKU
              AZ-4471」のような型番や固有名詞の完全一致検索に弱いという弱点が繰り返し報告されています。これが7章で解説する「ハイブリッド検索」が2026年の標準構成になっている理由です。
            </p>
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://aimultiple.com/embedding-models">
              ...
              <Ext href="https://modal.com/blog/mteb-leaderboard-article">
          ...
          <section className={`${styles.section} chapter`} id="sec-4">
            ...
            <p>
              複数の実務ガイドで共通する初期値は「300〜500トークン、10〜20%のオーバーラップ」です。2026年2月のあるベンダーベンチマークではRecursive
              512トークン分割が7戦略中最高スコアを記録し、別のLlamaIndexの調査では1024トークン付近が忠実性(Faithfulness)のピークに近いとされています。512〜1024トークンの範囲が妥当な出発点です。
            </p>
            <div className={`${styles.callout} ${styles.calloutWarning}`}>
              <i className="ti ti-alert-triangle" />
              <div>
                <strong>注意: </strong>
                オーバーラップの効果については意見が分かれています。2026年1月のある系統的分析(SPLADE検索+Mistral-8BによるNatural
                Questions検証)では、オーバーラップに測定可能な効果が見られず、インデックス作成コストが増えるだけだったという結果も報告されています。自社データでの検証が重要です。
              </div>
            </div>
            ...
            <p>
              Anthropicが提案したContextual
              Retrievalは、次のようなプロンプトで各チャンクに文脈を付与します(概念イメージ)。
            </p>
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://www.callmissed.com/en/blog/rag-best-practices-2026">
              ...
              <Ext href="https://www.firecrawl.dev/blog/best-chunking-strategies-rag">
                https://www.firecrawl.dev/blog/best-chunking-strategies-rag
              </Ext>
              <Ext href="https://atlan.com/know/chunking-strategies-rag/">
                https://atlan.com/know/chunking-strategies-rag/
              </Ext>
              <Ext href="https://www.anthropic.com/news/contextual-retrieval">
          ...
          <section className={`${styles.section} chapter`} id="sec-5">
            ...
            <ol className={styles.navListInline}>
              <li>
                <strong>モダリティ</strong>:
                テキストのみか、画像・音声・動画も含む「マルチモーダル」対応が必要か
              </li>
              <li>
                <strong>保存場所とセルフホスト可否</strong>:
                APIサービスを使うか、自社インフラで運用するか
              </li>
              <li>
            ...
            <h3>5.4 ドメイン特化モデル</h3>
            <p>
              コード検索にはVoyage code系やGemini Embedding 2(MTEB
              Codeスコアが高い)、法律文書・金融文書には専用にファインチューニングされたBGEやQwen3系モデルが候補として挙げられています。汎用モデルで自社の検索評価スコアが頭打ちになった場合にのみ、ファインチューニングやドメイン特化モデルへの切り替えを検討するのが現実的な順序です。
            </p>
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://pecollective.com/tools/best-embedding-models/">
              ...
              <Ext href="https://mixpeek.com/curated-lists/best-embedding-models">
                https://mixpeek.com/curated-lists/best-embedding-models
              </Ext>
              <Ext href="https://www.openxcell.com/blog/best-embedding-models/">
                https://www.openxcell.com/blog/best-embedding-models/
              </Ext>
              <Ext href="https://tensoria.fr/en/blog/embedding-models-2026-guide">
          ...
          <section className={`${styles.section} chapter`} id="sec-6">
            ...
            <p>
              Embeddingモデルはベクトルを生成するだけであり、それを保存し高速に検索するには別途ベクトルデータベースが必要です。多くの製品はHNSW(Hierarchical
              Navigable Small
              World)というグラフベースのアルゴリズムを採用しており、対数的な計算量で近似最近傍探索(ANN)を実現します。
            </p>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>OSS(Java実装)</td>
                    <td>
                      ネイティブなハイブリッド検索、自動ベクトル化モジュール、マルチテナンシー
                    </td>
            ...
            <ul className={styles.navListInline}>
              <li>
                すでにPostgresを使っており、ベクトル数が1,000万未満 → <strong>pgvector</strong>
                が第一候補
              </li>
              <li>
                運用チームを持たず、マネージドサービスを希望 → <strong>Pinecone</strong>
              </li>
              <li>
                ハイブリッド検索をネイティブに使いたい → <strong>Weaviate</strong>または
                <strong>Qdrant</strong>
              </li>
              <li>
                フィルタ付き検索の速度を最優先 → <strong>Qdrant</strong>
              </li>
              <li>
                1億〜10億ベクトル級の規模 → <strong>Milvus</strong>または<strong>Pinecone</strong>
              </li>
              <li>
                マルチモーダル検索 → <strong>Weaviate</strong>または<strong>LanceDB</strong>
              </li>
            </ul>
            <p>
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://encore.dev/articles/best-vector-databases">
                https://encore.dev/articles/best-vector-databases
              </Ext>
              <Ext href="https://www.firecrawl.dev/blog/best-vector-databases">
                https://www.firecrawl.dev/blog/best-vector-databases
              </Ext>
              <Ext href="https://www.datacamp.com/blog/the-top-5-vector-databases">
                https://www.datacamp.com/blog/the-top-5-vector-databases
              </Ext>
              <Ext href="https://iternal.ai/insights/best-vector-databases-2026">
              ...
              <Ext href="https://vecstore.app/blog/vector-database-performance-compared">
          ...
          <section className={`${styles.section} chapter`} id="sec-7">
            ...
            <p>
              Dense
              Embeddingによる意味検索は言い換えに強い一方、型番・固有名詞などの完全一致検索には弱いという弱点があります。逆にBM25のようなキーワード検索は完全一致には強いものの、言い換え表現を拾えません。この両者を組み合わせる
              <strong>ハイブリッド検索</strong>が2026年時点の実務標準になっています。
            </p>
            <p>
            ...
            <p>
              ハイブリッド検索でDense検索とBM25検索の結果を統合する代表的な手法がRRF(Reciprocal Rank
              Fusion)です。RRFはスコアそのものではなく「順位」に基づいて統合するため、Dense検索のスコアとBM25のスコアのスケールが違うという問題(スコア不整合問題)を回避できます。
            </p>
            ...
            <p>
              一次検索(Dense/BM25/ハイブリッド)で候補を50〜100件程度に絞り込んだ後、
              <strong>Cross-Encoder型のReranker</strong>
              でクエリとチャンクの組み合わせをより精密にスコアリングし、最終的に上位5〜10件程度に絞り込むのが定石です。
            </p>
            <div className={styles.tableWrap}>
              <table>
                <thead>
            ...
            <p>
              Rerankerは「一次検索のRecallは高いがPrecisionが低い」場合に効果を発揮します。逆に一次検索でそもそも正解チャンクが候補に入っていない(Recallが低い)場合は、Rerankerをいくら強化しても改善しません。RerankerをONにした場合とOFFにした場合の両方で、NDCG・Recallの変化・追加レイテンシの3点(通称「evalトライアングル」)を同じクエリセットで比較することが推奨されています。参考値として、Cohere
              Rerank
              3.5は2,000トークン未満のチャンクでp50あたり約80〜150ミリ秒、3,000トークンを超えるとp99で200ミリ秒以上のレイテンシが追加されると報告されています。
            </p>
            ...
            <ul className={styles.navListInline}>
              <li>
                ...
                LLMに理想的な回答の仮想文書を生成させ、そのEmbeddingで検索する手法
              </li>
              <li>
                <strong>Query Rewriting</strong>:
                曖昧・省略の多い質問を検索しやすい明確な形に言い換える
              </li>
              <li>
                <strong>Query Decomposition</strong>:
                複数の論点を含む質問を単一の論点に分解してそれぞれ検索する
              </li>
            </ul>
            <p>
              ある学術研究(TREC DL
              2019/2020データセット)では、教師あり手法がもっとも高い性能を示し、HyDEとハイブリッド検索を組み合わせた構成が最高スコアを記録した一方、クエリの書き換えや分解単体では検索性能の向上に必ずしもつながらなかったとされています。性能とレイテンシのバランスを考えると「ハイブリッド検索+HyDE」がデフォルトの推奨構成として挙げられています。
            </p>
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://futureagi.com/blog/evaluating-cohere-rerank-rag-2026/">
          ...
          <section className={`${styles.section} chapter`} id="sec-8">
            ...
            <ul className={styles.navListInline}>
              <li>
                <strong>件数を絞る</strong>:
                関連性の低いチャンクを大量に含めると、LLMが情報を平均化し回答の質が下がる(コンテキスト汚染)
              </li>
              <li>
                <strong>出典情報を明示する</strong>:
                各チャンクにメタデータ(文書名・セクション・URL等)を付与し、LLMに引用を促す
              </li>
              <li>
                <strong>ロングコンテキストとの使い分け</strong>:
                コンテキスト長が伸びるほど回答品質が劣化する「コンテキスト崖(context
                cliff)」現象が指摘されており、約2,500トークン付近を境に応答品質が下がり始めるという分析があります
              </li>
            </ul>
            ...
            <ol className={styles.navListInline}>
              ...
              <li>
                回答ルールの明示:
                「検索結果に含まれない情報は答えない」「不明な場合は不明と答える」といった制約を明記する
              </li>
          ...
          <section className={`${styles.section} chapter`} id="sec-9">
            ...
            <p>
              補助的な指標として、正解データがある場合には<strong>Answer Correctness</strong>
              を使い、事実の重なりと意味的類似度を組み合わせて生成回答と正解を直接比較することもあります。ラベル付きの正解文書がある場合はPrecision@k・Recall@k・MRR(Mean
              Reciprocal Rank)・NDCGといった伝統的な情報検索指標も併用されます。
            </p>
            ...
            <div className={`${styles.callout} ${styles.calloutWarning}`}>
              ...
              <div>
                <strong>実例: </strong>
                ある法律関連のRAG事例では、オフライン評価でFaithfulness
                0.91という高スコアを記録して本番稼働しましたが、3週間後にユーザーから「重要な条文が回答に含まれていない」という苦情が相次ぎました。ダッシュボード上のFaithfulnessは0.91のままでしたが、Context
                Recallを測定すると0.62まで落ち込んでいました。原因は、複数条文にまたがる質問(multi-hop)で検索側が2つ目の条文を取りこぼし、生成側は取得できた部分的な文脈から一貫性のある回答を作ってしまっていたことでした。「生成指標だけを見ていると検索の劣化を見逃す」という典型的な落とし穴です。
              </div>
            </div>
            ...
            <ul className={styles.navListInline}>
              <li>
                <strong>Ragas</strong>:
                チャンキングやEmbeddingモデルをチューニングする際のオフライン実験的評価
              </li>
              <li>
                <strong>DeepEval</strong>: CI/CDパイプラインに組み込むリリース前のゲート
              </li>
              <li>
                <strong>TruLens / LangSmith / Arize Phoenix</strong>:
                本番環境での継続的なオブザーバビリティ
              </li>
            </ul>
            <p>
          ...
          <section className={`${styles.section} chapter`} id="sec-10">
            ...
            <p>
              GraphRAGが特に効果を発揮するのは、規制コンプライアンス分析・研究統合・競合分析・サプライチェーンの依存関係分析など、
              <strong>複数文書をまたいだ関係性を問う質問(multi-hop)</strong>
              です。単純な事実検索であれば通常のベクトルRAGの方が高速・低コストで同等以上の精度を出せるとされています。
            </p>

            <h3>10.2 Agentic RAG</h3>
            <p>
              Agentic
              RAGは、LLM自身が検索の主導権を持ち、質問をサブクエリに分解し、どの検索ツールを呼ぶか判断し、結果を評価し、必要なら再検索するというループを回す手法です。単純な検索器としてではなく、LLMを「推論しながら検索するエージェント」として使う点が特徴です。複雑で曖昧な多段階質問に対してのみ品質向上分の価値があり、単純な事実質問に使うのは無駄なコストだと位置づけられています。1回のクエリあたりLLM呼び出しが3〜10倍に増えるという試算もあります。
            </p>

            <h3>10.3 Adaptive RAG(適応型ルーティング)</h3>
            <p>
              2026年に登場している最新のベストプラクティスが<strong>Adaptive RAG</strong>
              です。クエリの複雑さを分類する「複雑度分類器」を最初に置き、質問の性質によって異なるパイプラインへルーティングする設計です。
            </p>
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://ailearningguides.com/rag-production-patterns-2026/">
                https://ailearningguides.com/rag-production-patterns-2026/
              </Ext>
              <Ext href="https://jobsbyculture.com/blog/agentic-rag-guide-2026">
          ...
          <section className={`${styles.section} chapter`} id="sec-11">
            ...
            <ol className={styles.navListInline}>
              <li>
                Recursive
                Chunking(300〜500トークン、10〜20%オーバーラップ)で最初のパイプラインを作る
              </li>
            ...
            <p>
              Agentic
              RAGのようにLLMがツールを自律的に呼び出すパターンが増えるほど、検索対象の文書内に埋め込まれた悪意ある指示(間接的プロンプトインジェクション)による攻撃リスクも増加します。「完全な防御は存在しない」という前提のもと、次のような多層防御が推奨されています。
            </p>
            <ul className={styles.navListInline}>
          ...
          <section className={`${styles.section} chapter`} id="sec-13">
            ...
            <ul className={styles.checklist}>
              ...
              <li>
                <i className="ti ti-circle-check" />
                Faithfulness・Context Precision・Context Recall・Answer
                Relevancyを継続的に監視しているか
              </li>
              <li>
                <i className="ti ti-circle-check" />
          ...
          <section className={`${styles.section} chapter`} id="sec-14">
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://www.aitechboss.com/best-embedding-models-2026/">
              ...
              <Ext href="https://elephas.app/blog/best-embedding-models">
            ...
            <div className={styles.refBox}>
              ...
              <Ext href="https://app.ailog.fr/en/blog/guides/choosing-embedding-models">
      ...
      <footer className={styles.pageFooter}>
        <div className={styles.codeLine}>
          LLM Studies — RAG &amp; Embeddings Complete Guide (2026)
        </div>
      </footer>
    </div>
  );
