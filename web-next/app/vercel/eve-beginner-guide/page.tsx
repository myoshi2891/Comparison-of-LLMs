        ...
        <main className={styles.main} id="main">
          ...
          <section className={styles.section} id="overview">
            ...
            <p>
              ...
              は eve を「エージェントのための Next.js」と表現しています。Next.js
              がフォルダ構造だけで Web アプリのルーティングを解決したように、eve
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>現在のステータス</td>
                    <td>
                      パブリックベータ（Vercel Beta Terms 適用、GA前に破壊的変更の可能性あり）
                    </td>
                  </tr>
                  <tr>
                    <td>主な用途</td>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      焦点を絞ったタスクを、独立したコンテキストを持つ子エージェントに委譲する
                    </td>
                    <td>eveのエージェントループ</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      資格情報をコードから切り離し、MCPサーバーやOpenAPI互換APIに安全に接続する
                    </td>
            ...
            <div className={styles.step}>
              ...
              <div className={`${styles.callout} ${styles.calloutDanger}`}>
                ...
                <p>
                  ...
                  <strong>
                    404もエラーバナーも一切出ないまま、Slackイベントが静かに失われます
                  </strong>
                  。Agent
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      定型API呼び出しだけのエージェントにサンドボックスは不要な複雑性を持ち込む
                    </td>
                    <td>Roboto Studio社ブログ</td>
                  </tr>
                  <tr>
                    <td>7</td>
                    <td>
                      判断の難しいタスクには強いモデルを、機械的なタスクには軽量モデルを充てる
                    </td>
                    <td>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      現時点では推奨しない。Mastraのようなポータブルなフレームワークを検討する
                    </td>
                  </tr>
                  <tr>
