...
const MERMAID_DIAGRAM_4 = `flowchart TD
    ...
    D -- いいえ --> F{"数学証明・多段階ロジック・競技プログラミング級か?"}
      ...
      <main className={styles.main}>
        ...
        <section className={styles.block} id="sec-1">
          ...
          <p>
            ...
            です。xAI は「画像・動画・音声には専用モデル、それ以外はすべて Grok 4.5」という明確な方針を打ち出しています。
          </p>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>画像生成</td>
                  <td>
                    Grok Imagine API（<code>grok-imagine-image</code> / <code>grok-imagine-image-quality</code>）
                  </td>
                </tr>
                <tr>
                  <td>動画生成</td>
                  <td>
                    Grok Imagine API（<code>grok-imagine-video</code> / <code>grok-imagine-video-1.5</code>）
                  </td>
                </tr>
                <tr>
                  <td>音声</td>
          ...
          <div className={styles.callout}>
            <strong>ベストプラクティス:</strong> 迷ったら <code>grok-4.5</code>（エイリアス）を使用。
          ...
          <ul>
            <li>
              ...
              は学習データ以降のイベントを知らないため、最新情報が必要な場合は必ず Web Search / X Search
              ツールを有効化する必要があります。
            </li>
            <li>
              <strong><code>logprobs</code> / <code>top_logprobs</code> 非対応</strong>:{" "}
              <code>grok-4.20</code> 以降のモデルではこれらのフィールドはエラーにならず黙って無視されます。
            </li>
            <li>
          ...
          <p className={styles.dim}>
            ...
            <Ext href="https://docs.x.ai/developers/model-capabilities/text/reasoning">Reasoning | xAI Docs</Ext>
          </p>
        </section>
        ...
        <section className={styles.block} id="sec-2">
          ...
          <p>
            xAI API は OpenAI 互換の <strong>Responses API</strong>（<code>/v1/responses</code>）を主軸としつつ、xAI
            ネイティブの Python/gRPC SDK（<code>xai-sdk</code>）も提供しています。レガシーな Chat Completions（
            <code>/v1/chat/completions</code>）も引き続き利用可能ですが、新規実装では Responses API が推奨です。
          </p>
          ...
          <div className={styles.callout}>
            <strong>ポイント:</strong> サーバーサイドツール（Web Search・X Search・Code Execution・Remote MCP）は
            xAI 側で自動実行され応答に組み込まれますが、Function Calling（クライアントサイドツール）は必ず一度ターンが「一時停止」し、開発者側で実行して結果を返す必要があります。この違いを理解することがエージェント設計の第一歩です。
          </div>

          <p className={styles.dim}>
            出典: <Ext href="https://docs.x.ai/overview">Overview | xAI Docs</Ext> ／{" "}
            <Ext href="https://docs.x.ai/developers/tools/function-calling">Function Calling | xAI Docs</Ext> ／{" "}
        ...
        <section className={styles.block} id="sec-3">
          ...
          <div className={styles.codeBlock}>
            <div className={styles.codeLine}>
              <span className={styles.ck}>export</span> <span className={styles.cv}>XAI_API_KEY</span>=
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              <span className={styles.cc}># OpenAI SDK 経由（base_url を差し替えるだけで利用可能）</span>
            </div>
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk <span className={styles.ck}>import</span> Client
            </div>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.chat <span className={styles.ck}>import</span> user
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              client = Client(api_key=os.getenv(<span className={styles.cs}>&quot;XAI_API_KEY&quot;</span>))
            </div>
            <div className={styles.codeLine}>
              chat = client.chat.create(model=<span className={styles.cs}>&quot;grok-4.5&quot;</span>)
            </div>
            <div className={styles.codeLine}>
              chat.append(user(<span className={styles.cs}>&quot;Fix this function and explain the bug: function median(a){`{a.sort();return a[a.length/2]}`}&quot;</span>))
            </div>
            <div className={styles.codeLine} />
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              {"  "}-H <span className={styles.cs}>&quot;Authorization: Bearer $XAI_API_KEY&quot;</span> \
            </div>
            <div className={styles.codeLine}>
            ...
            <div className={styles.codeLine}>
              {"    "}<span className={styles.cs}>&quot;model&quot;</span>: <span className={styles.cs}>&quot;grok-4.5&quot;</span>,
            </div>
            <div className={styles.codeLine}>
              {"    "}<span className={styles.cs}>&quot;input&quot;</span>: <span className={styles.cs}>&quot;Fix this function and explain the bug&quot;</span>
            </div>
        ...
        <section className={styles.block} id="sec-4">
          ...
          <p>
            <code>grok-4.5</code> は <code>reasoning_effort</code> パラメータで思考の深さを制御できます。
            <strong>指定しない場合はデフォルトで <code>&quot;high&quot;</code> になり、reasoning 自体を無効化することはできません。</strong>
          </p>
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.chat <span className={styles.ck}>import</span> system, user
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              client = Client(api_key=os.getenv(<span className={styles.cs}>&quot;XAI_API_KEY&quot;</span>), timeout=3600)
            </div>
            <div className={styles.codeLine} />
            ...
            <div className={styles.codeLine}>
              {"    "}messages=[system(<span className={styles.cs}>&quot;You are a highly intelligent AI assistant.&quot;</span>)],
            </div>
            <div className={styles.codeLine}>)</div>
            <div className={styles.codeLine}>
              chat.append(user(<span className={styles.cs}>&quot;Find all prime numbers p such that p^2 + 2 is also prime. Prove your answer.&quot;</span>))
            </div>
            <div className={styles.codeLine} />
          ...
          <div className={`${styles.callout} ${styles.warn}`}>
            <strong>注意:</strong> reasoning モデルでは <code>presencePenalty</code> / <code>frequencyPenalty</code> /{" "}
            <code>stop</code> を指定するとエラーになります。reasoning トークンも通常のトークンと同様に課金対象です。
          </div>
          ...
          <p>
            ...
            を指定します。また、モデル内部の思考過程の要約を <code>reasoning_content</code>（xAI SDK）や{" "}
            <code>response.reasoning_text.delta</code>（Responses API）としてストリーミングで取得でき、デバッグや「thinking…」表示に活用できます。
          </p>
          ...
          <div className={styles.tableWrap}>
            <table>
              <thead>
                <tr>
                  <th>モデル</th>
                  <th><code>reasoning</code> パラメータ</th>
                  <th>挙動</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <code>&quot;low&quot;/&quot;medium&quot;/&quot;high&quot;/&quot;xhigh&quot;</code>
                  </td>
          ...
          <p className={styles.dim}>
            出典: <Ext href="https://docs.x.ai/developers/model-capabilities/text/reasoning">Reasoning | xAI Docs</Ext>
          </p>
        </section>
        ...
        <section className={styles.block} id="sec-5">
          ...
          <p>
            2つのアプローチがあります。(1) <code>response_format</code> パラメータで <code>type: &quot;json_schema&quot;</code>{" "}
            を指定し、Pydantic/Zod で定義したスキーマに準拠した JSON を「保証」して取得する方法。(2) Tool Calling 経由 —{" "}
            ツール定義を行うと、モデルは常に厳密にスキーマ準拠の引数を生成します（<code>strict</code> は暗黙的に常に <code>true</code>）。
          </p>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>基本型</td>
                  <td>
                    <code>string</code> / <code>number</code> / <code>integer</code> / <code>boolean</code> / <code>null</code> /{" "}
                    <code>enum</code> / <code>const</code> / <code>array</code> / <code>object</code>
                  </td>
                </tr>
                <tr>
                  <td>結合</td>
                  <td>
                    <code>anyOf</code>（<code>oneOf</code> は同一挙動）/ <code>allOf</code>（単一サブスキーマのみ完全保証）
                  </td>
                </tr>
                <tr>
                  <td>参照</td>
                ...
                <tr>
                  <td>文字列フォーマット（強制）</td>
                  <td>
                    <code>date</code> / <code>time</code> / <code>date-time</code> / <code>email</code> / <code>uuid</code> /{" "}
                    <code>ipv4</code> / <code>ipv6</code> / <code>uri</code>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className={`${styles.callout} ${styles.warn}`}>
            <strong>注意:</strong> <code>not</code> / <code>if-then-else</code> / 複数の <code>allOf</code> / 未サポートの{" "}
            <code>format</code> は「ベストエフォート」扱いで保証されません。<code>additionalProperties</code> はデフォルト{" "}
            <code>false</code> のため、許可したい場合は明示的に <code>true</code> を指定してください。また正規表現（
            <code>pattern</code>）は後方参照・先読み/後読み・単語境界（<code>\b</code>）に非対応です。
          </div>
          ...
          <div className={styles.codeBlock}>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> datetime <span className={styles.ck}>import</span> date
            </div>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> enum <span className={styles.ck}>import</span> Enum
            </div>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> pydantic <span className={styles.ck}>import</span> BaseModel, Field
            </div>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk <span className={styles.ck}>import</span> Client
            </div>
            ...
            <div className={styles.codeLine}>
              {"    "}USD = <span className={styles.cs}>&quot;USD&quot;</span>; EUR = <span className={styles.cs}>&quot;EUR&quot;</span>; GBP = <span className={styles.cs}>&quot;GBP&quot;</span>
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
            ...
            <div className={styles.codeLine}>
              chat.append(system(<span className={styles.cs}>&quot;Given a raw invoice, extract the invoice data into JSON format.&quot;</span>))
            </div>
            <div className={styles.codeLine}>
              chat.append(user(<span className={styles.cs}>&quot;Vendor: Acme Corp ... Total: $80.00 USD&quot;</span>))
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>response, invoice = chat.parse(Invoice)</div>
            <div className={styles.codeLine}>print(invoice.vendor_name, invoice.total_amount, invoice.currency)</div>
          </div>

          <h3>5.5 Structured Outputs × エージェント型ツールの組み合わせ</h3>
          <p>
            <code>grok-4</code> ファミリーの対応モデルでは、Web Search 等でリサーチを行い、その結果を型安全な JSON として返すことが可能です。
          </p>
          <div className={styles.codeLabel}>python</div>
          <div className={styles.codeBlock}>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> pydantic <span className={styles.ck}>import</span> BaseModel
            </div>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.tools <span className={styles.ck}>import</span> web_search
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
            ...
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              chat = client.chat.create(model=<span className={styles.cs}>&quot;grok-4.5&quot;</span>, tools=[web_search()])
            </div>
            <div className={styles.codeLine}>
              chat.append(user(<span className={styles.cs}>&quot;Find the latest machine-checked proof of the four color theorem.&quot;</span>))
            </div>
            <div className={styles.codeLine}>response, proof = chat.parse(ProofInfo)</div>
          </div>

          <p className={styles.dim}>
            出典: <Ext href="https://docs.x.ai/developers/model-capabilities/text/structured-outputs">Structured Outputs | xAI Docs</Ext>
          </p>
        </section>
        ...
        <section className={styles.block} id="sec-6">
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.chat <span className={styles.ck}>import</span> user, tool, tool_result
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              client = Client(api_key=os.getenv(<span className={styles.cs}>&quot;XAI_API_KEY&quot;</span>))
            ...
            <div className={styles.codeLine}>
              {"        "}description=<span className={styles.cs}>&quot;Get current temperature for a location&quot;</span>,
            </div>
            <div className={styles.codeLine}>{"        "}parameters=&#123;</div>
            <div className={styles.codeLine}>
              {"            "}<span className={styles.cs}>&quot;type&quot;</span>: <span className={styles.cs}>&quot;object&quot;</span>,
            </div>
            <div className={styles.codeLine}>
              {"            "}<span className={styles.cs}>&quot;properties&quot;</span>: &#123;
            </div>
            <div className={styles.codeLine}>
              {"                "}<span className={styles.cs}>&quot;location&quot;</span>: &#123;<span className={styles.cs}>&quot;type&quot;</span>: <span className={styles.cs}>&quot;string&quot;</span>, <span className={styles.cs}>&quot;description&quot;</span>: <span className={styles.cs}>&quot;City name&quot;</span>&#125;,
            </div>
            <div className={styles.codeLine}>
              {"                "}<span className={styles.cs}>&quot;unit&quot;</span>: &#123;<span className={styles.cs}>&quot;type&quot;</span>: <span className={styles.cs}>&quot;string&quot;</span>, <span className={styles.cs}>&quot;enum&quot;</span>: [<span className={styles.cs}>&quot;celsius&quot;</span>, <span className={styles.cs}>&quot;fahrenheit&quot;</span>], <span className={styles.cs}>&quot;default&quot;</span>: <span className={styles.cs}>&quot;fahrenheit&quot;</span>&#125;
            </div>
            <div className={styles.codeLine}>{"            "}&#125;,</div>
            <div className={styles.codeLine}>
              {"            "}<span className={styles.cs}>&quot;required&quot;</span>: [<span className={styles.cs}>&quot;location&quot;</span>]
            </div>
            <div className={styles.codeLine}>{"        "}&#125;,</div>
            <div className={styles.codeLine}>{"    "}),</div>
            <div className={styles.codeLine}>]</div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              chat = client.chat.create(model=<span className={styles.cs}>&quot;grok-4.5&quot;</span>, tools=tools)
            </div>
            <div className={styles.codeLine}>
              chat.append(user(<span className={styles.cs}>&quot;What is the temperature in San Francisco?&quot;</span>))
            </div>
            <div className={styles.codeLine}>response = chat.sample()</div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
            ...
            <div className={styles.codeLine}>
              {"    "}<span className={styles.ck}>for</span> tc <span className={styles.ck}>in</span> response.tool_calls:
            </div>
            <div className={styles.codeLine}>{"        "}args = json.loads(tc.function.arguments)</div>
            <div className={styles.codeLine}>
              {"        "}result = &#123;<span className={styles.cs}>&quot;location&quot;</span>: args[<span className={styles.cs}>&quot;location&quot;</span>], <span className={styles.cs}>&quot;temperature&quot;</span>: 59, <span className={styles.cs}>&quot;unit&quot;</span>: args.get(<span className={styles.cs}>&quot;unit&quot;</span>, <span className={styles.cs}>&quot;fahrenheit&quot;</span>)&#125;
            </div>
            <div className={styles.codeLine}>{"        "}chat.append(tool_result(json.dumps(result)))</div>
            <div className={styles.codeLine}>{"    "}response = chat.sample()</div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>print(response.content)</div>
          </div>
          ...
          <div className={styles.callout}>
            <strong>並列関数呼び出し:</strong> デフォルトで有効。1回の応答で複数の <code>tool_call</code>{" "}
          ...
          <div className={styles.codeBlock}>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.tools <span className={styles.ck}>import</span> web_search, x_search
            </div>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.chat <span className={styles.ck}>import</span> tool
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>tools = [</div>
            <div className={styles.codeLine}>
            ...
            <div className={styles.codeLine}>
              {"        "}description=<span className={styles.cs}>&quot;Save research results to the database&quot;</span>,
            </div>
            <div className={styles.codeLine}>
              {"        "}parameters=&#123;<span className={styles.cs}>&quot;type&quot;</span>: <span className={styles.cs}>&quot;object&quot;</span>, <span className={styles.cs}>&quot;properties&quot;</span>: &#123;<span className={styles.cs}>&quot;data&quot;</span>: &#123;<span className={styles.cs}>&quot;type&quot;</span>: <span className={styles.cs}>&quot;string&quot;</span>&#125;&#125;, <span className={styles.cs}>&quot;required&quot;</span>: [<span className={styles.cs}>&quot;data&quot;</span>]&#125;,
            </div>
            <div className={styles.codeLine}>{"    "}),</div>
            <div className={styles.codeLine}>]</div>
          </div>
          ...
          <p className={styles.dim}>
            出典: <Ext href="https://docs.x.ai/developers/tools/function-calling">Function Calling | xAI Docs</Ext> ／{" "}
            <Ext href="https://docs.x.ai/docs/guides/tools/advanced-usage">Advanced Usage | xAI Docs</Ext>
          </p>
        </section>
        ...
        <section className={styles.block} id="sec-7">
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              {"    "}tools=[web_search(allowed_domains=[<span className={styles.cs}>&quot;example.com&quot;</span>])],
            </div>
            <div className={styles.codeLine}>)</div>
          </div>
          ...
          <div className={styles.codeBlock}>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.tools <span className={styles.ck}>import</span> x_search
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              chat = client.chat.create(model=<span className={styles.cs}>&quot;grok-4.5&quot;</span>, tools=[x_search()])
            </div>
            <div className={styles.codeLine}>
              chat.append(user(<span className={styles.cs}>&quot;What are people saying about xAI on X?&quot;</span>))
            </div>
          </div>

          <div className={`${styles.callout} ${styles.warn}`}>
            <strong>移行に関する注意:</strong> 旧来の <code>search_parameters</code> を使う Live Search API
            は2026年1月12日に廃止済みです。Responses API の <code>tools</code> パラメータへの移行が必須です。
          </div>

          <h3>7.3 Code Execution</h3>
          <p>サンドボックス化された Python 環境でコードを実行し、正確な数値計算・データ分析・統計処理・シミュレーションを行います。</p>

          <div className={styles.codeLabel}>python</div>
          <div className={styles.codeBlock}>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.tools <span className={styles.ck}>import</span> code_execution
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              chat = client.chat.create(model=<span className={styles.cs}>&quot;grok-4.3&quot;</span>, tools=[code_execution()])
            </div>
            <div className={styles.codeLine}>
              chat.append(user(<span className={styles.cs}>&quot;Calculate the compound interest for $10,000 at 5% annually for 10 years&quot;</span>))
            </div>
          </div>

          <p>
            <strong>ベストプラクティス:</strong>{" "}
            ①曖昧な指示ではなく具体的に指示する（例:「相関行列を計算し 0.7 以上をハイライト」）。②データフォーマットと制約を明示する。③数値計算では
            temperature を低め（0.0〜0.3）に設定する。
          </p>
          <p className={styles.dim}>
            制約: ネットワーク・外部ファイルシステムへのアクセス不可、リクエスト間で状態は保持されない（ステートレス）、NumPy/Pandas/Matplotlib/SciPy
            等の主要ライブラリのみ利用可能。
          </p>

          <h3>7.4 Remote MCP Tools（Model Context Protocol）</h3>
          <p>
            外部の MCP サーバーに接続し、サードパーティ製・自社製のカスタムツール群を Grok に与えることができます。xAI
            側が接続・実行を代行します。
          </p>
          ...
          <div className={styles.codeBlock}>
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> xai_sdk.tools <span className={styles.ck}>import</span> mcp
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>chat = client.chat.create(</div>
            <div className={styles.codeLine}>
            ...
            <div className={styles.codeLine}>{"    "}tools=[</div>
            <div className={styles.codeLine}>
              {"        "}mcp(server_url=<span className={styles.cs}>&quot;https://mcp.deepwiki.com/mcp&quot;</span>, server_label=<span className={styles.cs}>&quot;deepwiki&quot;</span>),
            </div>
            <div className={styles.codeLine}>{"        "}mcp(</div>
            <div className={styles.codeLine}>
              {"            "}server_url=<span className={styles.cs}>&quot;https://your-custom-tools.com/mcp&quot;</span>,
            </div>
            <div className={styles.codeLine}>
              {"            "}server_label=<span className={styles.cs}>&quot;custom&quot;</span>,
            </div>
            <div className={styles.codeLine}>
              {"            "}allowed_tool_names=[<span className={styles.cs}>&quot;search_database&quot;</span>, <span className={styles.cs}>&quot;format_data&quot;</span>],
            </div>
            <div className={styles.codeLine}>{"        "}),</div>
            <div className={styles.codeLine}>{"    "}],</div>
            <div className={styles.codeLine}>)</div>
          ...
          <div className={styles.callout}>
            ...
            <code>server_label</code>/<code>server_description</code> を明確にし、常に HTTPS + 適切な認証を使用してください。なお xAI 自身も{" "}
            <Ext href="https://docs.x.ai/developers/docs-mcp">Docs MCP</Ext>（<code>https://docs.x.ai/api/mcp</code>）を公開しています。
          </div>
        ...
        <section className={styles.block} id="sec-8">
          <h2>
            <span className={styles.num}>08</span> Realtime Multi-agent Research <span className={styles.badge}>BETA</span>
          </h2>
          <p>
          ...
          <div className={`${styles.callout} ${styles.warn}`}>
            <strong>重要な制約:</strong> ユーザーに返るのはリーダーエージェントのツール呼び出しと最終回答のみ。サブエージェントの中間状態は暗号化され{" "}
            <code>use_encrypted_content=True</code>{" "}
            指定時のみ保持されます。クライアントサイドのカスタムツール（Function Calling）は非対応、Chat Completions API も非対応、
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              chat = client.chat.create(model=<span className={styles.cs}>&quot;grok-4.20-multi-agent&quot;</span>, agent_count=4)
            </div>
            <div className={styles.codeLine}>
              chat.append(user(<span className={styles.cs}>&quot;What are the key differences between TCP and UDP?&quot;</span>))
            </div>
          </div>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>—</td>
                  <td>
                    &quot;Present your findings as a comparison table with categories: scalability, complexity, deployment, team size.&quot;
                  </td>
                </tr>
                <tr>
                  <td>ソースや観点を指定する</td>
                  <td>—</td>
                  <td>&quot;Cite recent academic papers and industry reports from 2024-2025.&quot;</td>
                </tr>
                <tr>
                  <td>複雑な調査は会話で分割する</td>
          ...
          <p className={styles.dim}>
            出典: <Ext href="https://docs.x.ai/developers/model-capabilities/text/multi-agent">Multi Agent | xAI Docs</Ext>
          </p>
        </section>
        ...
        <section className={styles.block} id="sec-9">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>同一会話 ID のリクエストを同一サーバーにルーティングし、キャッシュ再利用率を高める</td>
                </tr>
                <tr>
                  <td>
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              {"    "}extra_body=&#123;<span className={styles.cs}>&quot;prompt_cache_key&quot;</span>: <span className={styles.cs}>&quot;b79ad29b-b3f9-463c-bca6-041d5058d366&quot;</span>&#125;,
            </div>
            <div className={styles.codeLine}>)</div>
            <div className={styles.codeLine}>
              print(f<span className={styles.cs}>&quot;Cached tokens: &#123;response.usage.input_tokens_details.cached_tokens&#125;&quot;</span>)
            </div>
          </div>
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              {"      "}&#123;<span className={styles.cs}>&quot;role&quot;</span>: <span className={styles.cs}>&quot;system&quot;</span>, <span className={styles.cs}>&quot;content&quot;</span>: <span className={styles.cs}>&quot;You are Grok, built by xAI.&quot;</span>&#125;,
            </div>
            <div className={styles.codeLine}>
              {"      "}&#123;<span className={styles.cs}>&quot;role&quot;</span>: <span className={styles.cs}>&quot;user&quot;</span>, <span className={styles.cs}>&quot;content&quot;</span>: <span className={styles.cs}>&quot;What is prompt caching?&quot;</span>&#125;
            </div>
            <div className={styles.codeLine}>{"    "}]</div>
            <div className={styles.codeLine}>{"  "}&#125;</div>
          </div>
          ...
          <ul>
            ...
            <li>ツール呼び出し結果を含むメッセージまでがキャッシュ可能プレフィックスに含まれる。</li>
            <li>
              <code>cached_tokens</code> が常に <code>0</code> の場合は、会話 ID の設定漏れやメッセージ改変を疑う。
            </li>
          </ul>

          <p className={styles.dim}>
            出典: <Ext href="https://docs.x.ai/developers/advanced-api-usage/prompt-caching">Prompt Caching</Ext> ／{" "}
            <Ext href="https://docs.x.ai/developers/advanced-api-usage/prompt-caching/how-it-works">How It Works</Ext> ／{" "}
            <Ext href="https://docs.x.ai/developers/advanced-api-usage/prompt-caching/maximizing-cache-hits">Maximizing Cache Hits</Ext> ／{" "}
            <Ext href="https://docs.x.ai/developers/advanced-api-usage/prompt-caching/best-practices">Best Practices &amp; FAQ</Ext>（すべて xAI Docs）
          </p>
        </section>
        ...
        <section className={styles.block} id="sec-10">
          ...
          <p>
            ...
            <strong>Context Compaction</strong> は会話を単一の不透明（opaque）なアイテムに圧縮する機能です。
          </p>
          ...
          <h3>10.1 いつ圧縮すべきか</h3>
          <p>以下の<strong>すべて</strong>が真の場合に圧縮を検討します。</p>
          <ul>
            <li>
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              client = Client(api_key=os.environ[<span className={styles.cs}>&quot;XAI_API_KEY&quot;</span>])
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              chat = client.chat.create(model=<span className={styles.cs}>&quot;grok-4.3&quot;</span>, use_encrypted_content=<span className={styles.ck}>True</span>)
            </div>
            <div className={styles.codeLine}>
              chat.append(system(<span className={styles.cs}>&quot;You are a helpful assistant. Keep answers brief.&quot;</span>))
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>compact_every = 5</div>
            <div className={styles.codeLine}>
              <span className={styles.ck}>for</span> turn <span className={styles.ck}>in</span> range(1, 100):
            </div>
            <div className={styles.codeLine}>
            ...
            <div className={styles.codeLine}>
              {"        "}print(f<span className={styles.cs}>&quot;[compacted &#123;before&#125; -&gt; &#123;len(chat.messages)&#125; messages | dropped &#123;compact.dropped_message_count&#125; | tokens: &#123;compact.usage.total_tokens&#125;]&quot;</span>)
            </div>
          </div>

          <div className={`${styles.callout} ${styles.warn}`}>
            <strong>制約:</strong> 1リクエストにつき圧縮は1パスのみ。<code>encrypted_content</code>{" "}
            は不透明として扱い、パース・編集・手動マージをしてはならない。常に <code>output</code> 配列全体をそのまま次のリクエストに渡すこと。
          </div>

          <p className={styles.dim}>
            出典: <Ext href="https://docs.x.ai/developers/advanced-api-usage/context-compaction">Context Compaction | xAI Docs</Ext>
          </p>
        </section>
        ...
        <section className={styles.block} id="sec-11">
          ...
          <p>
            各チームは <strong>RPS</strong>（Requests Per Second）と <strong>TPM</strong>（Tokens Per Minute）の2軸でモデルごとの上限を持ちます。上限は2026年1月1日以降の累積課金額に基づく「Tier」によって段階的に引き上げられ、一度到達した Tier は永続的に維持されます。
          </p>
          ...
          <h3>11.1 <code>grok-4.5</code> のレート制限例</h3>
          <div className={styles.tableWrap}>
            <table>
              <thead>
                <tr>
          ...
          <p className={styles.dim}>
            TPM にはプロンプトトークン・出力トークン・推論トークン・キャッシュされたトークン（割引単価でも TPM 自体にはカウントされる）すべてが含まれます。
          </p>
          ...
          <div className={styles.codeBlock}>
            ...
            <div className={styles.codeLine}>
              <span className={styles.ck}>from</span> openai <span className={styles.ck}>import</span> OpenAI, RateLimitError
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
              client = OpenAI(base_url=<span className={styles.cs}>&quot;https://api.x.ai/v1&quot;</span>, api_key=os.getenv(<span className={styles.cs}>&quot;XAI_API_KEY&quot;</span>))
            </div>
            <div className={styles.codeLine} />
            <div className={styles.codeLine}>
            ...
            <div className={styles.codeLine}>
              {"    "}<span className={styles.ck}>for</span> attempt <span className={styles.ck}>in</span> range(max_retries):
            </div>
            <div className={styles.codeLine}>{"        "}<span className={styles.ck}>try</span>:</div>
            <div className={styles.codeLine}>
              {"            "}<span className={styles.ck}>return</span> client.chat.completions.create(model=<span className={styles.cs}>&quot;grok-4.5&quot;</span>, messages=messages)
            </div>
            <div className={styles.codeLine}>
              {"        "}<span className={styles.ck}>except</span> RateLimitError:
            </div>
            <div className={styles.codeLine}>{"            "}time.sleep(2 ** attempt)</div>
            <div className={styles.codeLine}>{"    "}<span className={styles.ck}>raise</span></div>
          </div>
        ...
        <section className={styles.block} id="sec-12">
          ...
          <p>
            リアルタイム性が不要な大量処理は Batch API で最大 <strong>20%</strong> の割引を受けられます（対象: <code>grok-4.3</code>,{" "}
            <code>grok-4.20-0309-reasoning</code>, <code>grok-4.20-0309-non-reasoning</code>,{" "}
            <code>grok-4.20-multi-agent-0309</code>）。
          </p>
          ...
          <p>
            低レイテンシが必要なリクエストは標準料金の <strong>2倍</strong> を支払うことで優先スケジューリングを受けられます。レスポンスの{" "}
            <code>service_tier</code> が <code>&quot;priority&quot;</code>{" "}
            になっている場合のみ優先料金が課金される点に注意してください。画像/動画生成・Batch API には非対応です。
          </p>
        ...
        <section className={styles.block} id="sec-13">
          ...
          <ul>
            ...
            <li>
              <strong>HTTPS + 認証必須</strong>: 自社 MCP サーバーを公開する場合は必ず HTTPS と <code>authorization</code>{" "}
              トークンで認証する。
            </li>
            <li>
              <strong>サードパーティ MCP サーバーの信頼性評価</strong>: 外部が公開する MCP サーバーの提供元の信頼性とツールの権限範囲を事前に確認する。
            </li>
          </ul>
          ...
          <ul>
            <li>
              モデルが生成した引数は<strong>信頼できない入力</strong>として扱い、実行前にバリデーションする。
            </li>
          ...
          <div className={`${styles.callout} ${styles.warn}`}>
            <strong>課金上の注意:</strong> xAI のシステムが利用ガイドライン違反と判定したリクエストは、生成前に検出された場合でも{" "}
        ...
        <section className={styles.block} id="sec-14">
          ...
          <ul className={styles.checklist}>
            <li>
              <label>
                <input type="checkbox" disabled /> モデル選定: <code>grok-4.5</code>（汎用）/ <code>grok-4.3</code>
                （長文脈・低コスト）/ <code>grok-4.20-multi-agent</code>（ディープリサーチ）を用途で使い分けたか
              </label>
            </li>
            <li>
              <label>
            ...
            <li>
              <label>
                <input type="checkbox" disabled /> Structured Outputs のスキーマ制約を把握し、必要なら二重検証を実装したか
              </label>
            </li>
            <li>
              <label>
                <input type="checkbox" disabled /> Function Calling のツール引数をアプリケーション側でバリデーションしているか
              </label>
            </li>
            <li>
              <label>
                <input type="checkbox" disabled /> Web Search / X Search の <code>allowed_domains</code>/
                <code>excluded_domains</code> でスコープを制限しているか
              </label>
            </li>
            <li>
              <label>
                <input type="checkbox" disabled /> Remote MCP Tools に <code>allowed_tools</code> で最小権限を設定したか
              </label>
            </li>
            <li>
              <label>
                <input type="checkbox" disabled /> <code>x-grok-conv-id</code> または <code>prompt_cache_key</code>{" "}
                を設定し、<code>cached_tokens</code> で効果を確認したか
              </label>
            </li>
            <li>
              <label>
                <input type="checkbox" disabled /> 長時間会話に対して Context Compaction の導入を検討したか
              </label>
            </li>
            <li>
              <label>
            ...
            <li>
              <label>
                <input type="checkbox" disabled /> チームの Rate Limit Tier と RPS/TPM 上限を把握し、負荷試験を行ったか
              </label>
            </li>
            <li>
              <label>
                <input type="checkbox" disabled /> Batch API / Priority Processing の使い分け基準をワークロードごとに定義したか
              </label>
            </li>
            <li>
              <label>
                <input type="checkbox" disabled /> コスト監視: <code>usage</code> と <code>server_side_tool_usage</code>{" "}
                を継続的にロギングしているか
              </label>
            </li>
          </ul>
        ...
        <section className={styles.block} id="sec-15">
          ...
          <p>本ガイドの内容はすべて以下の xAI 公式ドキュメント（2026年7月時点）および公式サイトを参照して作成しています。</p>
          ...
          <div className={styles.refs}>
            <ul>
              ...
              <li>
                ...
                <Ext href="https://docs.x.ai/developers/quickstart">https://docs.x.ai/developers/quickstart</Ext>
              </li>
              <li>
                <span className={styles.label}>Models</span>
                <Ext href="https://docs.x.ai/developers/models">https://docs.x.ai/developers/models</Ext>
              </li>
              <li>
                <span className={styles.label}>Pricing</span>
                <Ext href="https://docs.x.ai/developers/pricing">https://docs.x.ai/developers/pricing</Ext>
              </li>
              <li>
              ...
              <li>
                ...
                <Ext href="https://docs.x.ai/docs/guides/tools/overview">https://docs.x.ai/docs/guides/tools/overview</Ext>
              </li>
              <li>
              ...
              <li>
                ...
                <Ext href="https://docs.x.ai/developers/tools/web-search">https://docs.x.ai/developers/tools/web-search</Ext>
              </li>
              <li>
                <span className={styles.label}>X Search</span>
                <Ext href="https://docs.x.ai/developers/tools/x-search">https://docs.x.ai/developers/tools/x-search</Ext>
              </li>
              <li>
              ...
              <li>
                ...
                <Ext href="https://docs.x.ai/developers/tools/remote-mcp">https://docs.x.ai/developers/tools/remote-mcp</Ext>
              </li>
              <li>
                <span className={styles.label}>Docs MCP</span>
                <Ext href="https://docs.x.ai/developers/docs-mcp">https://docs.x.ai/developers/docs-mcp</Ext>
              </li>
              <li>
              ...
              <li>
                ...
                <Ext href="https://docs.x.ai/developers/rate-limits">https://docs.x.ai/developers/rate-limits</Ext>
              </li>
            </ul>
          </div>

          <footer className={styles.pageFooter}>
            xAI のドキュメントは頻繁に更新されます。本番導入前には必ず上記リンクから最新版をご確認ください。
            <br />
